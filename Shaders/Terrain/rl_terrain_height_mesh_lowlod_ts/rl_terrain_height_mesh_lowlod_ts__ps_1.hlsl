...
{
    float4 _68 = r0;
    _68.x = mad(shader_in[4].xyz.z, shader_in[4].xyz.z, mad(shader_in[4].xyz.y, shader_in[4].xyz.y, shader_in[4].xyz.x * shader_in[4].xyz.x));
    r0 = _68;
    float4 _73 = r0;
    _73.y = rsqrt(r0.x);
    r0 = _73;
    ...
    r0 = _99;
    float3 _106 = r0.yyy * shader_in[4].xyz;
    r0 = float4(r0.x, _106.x, _106.y, _106.z);
    float3 _111 = -r0.yzw;
    float4 _126 = r1;
    _126.x = mad(_111.z, shader_in[3].xyz.z, mad(_111.y, shader_in[3].xyz.y, _111.x * shader_in[3].xyz.x));
    r1 = _126;
    float4 _135 = r1;
    ...
    r0 = _188;
    float4 _205 = r1;
    _205.x = mad(shader_in[2].xyz.z, shader_in[2].xyz.z, mad(shader_in[2].xyz.y, shader_in[2].xyz.y, shader_in[2].xyz.x * shader_in[2].xyz.x));
    r1 = _205;
    float4 _210 = r1;
    _210.x = rsqrt(r1.x);
    r1 = _210;
    float3 _217 = r1.xxx * shader_in[2].xyz;
    ...
    float4 _325 = r0;
    _325.w = (-shader_in[3].w) + asfloat(1065353216u);
    r0 = _325;
    float3 _331 = r0.xyz * r0.www;
    r0 = float4(_331.x, _331.y, _331.z, r0.w);
    float4 _337 = r0;
    _337.w = shader_in[4].w;
    r0 = _337;
