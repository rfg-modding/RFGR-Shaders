...
void ps_main()
{
    r0 = tex2D(SPIRV_Cross_Combinedt4s4, shader_in[3].xyxx.xy);
    ...
    _134.z = sqrt(r0.w);
    r0 = _134;
    r1 = tex2D(SPIRV_Cross_Combinedt5s5, shader_in[4].zwzz.xy);
    ...
    _189.z = sqrt(r0.w);
    r1 = _189;
    r2 = tex2D(SPIRV_Cross_Combinedt8s8, shader_in[4].xyxx.xy);
    ...
    r3 = tex2D(SPIRV_Cross_Combinedt6s6, shader_in[5].xyxx.xy);
    ...
    r3 = tex2D(SPIRV_Cross_Combinedt7s7, shader_in[3].zwzz.xy);
    ...
    float4 _426 = r1;
    _426.x = shader_in[1].w + asfloat(3281059840u);
    r1 = _426;
    float4 _436 = r1;
    ...
    float4 _464 = r1;
    _464.y = mad(shader_in[2].xyz.z, shader_in[2].xyz.z, mad(shader_in[2].xyz.y, shader_in[2].xyz.y, shader_in[2].xyz.x * shader_in[2].xyz.x));
    r1 = _464;
    float4 _469 = r1;
    _469.y = rsqrt(r1.y);
    r1 = _469;
    float3 _476 = r1.yyy * shader_in[2].xyz;
    r3 = float4(_476.x, _476.y, _476.z, r3.w);
    float4 _493 = r1;
    _493.y = clamp(mad(r0.xyz.z, r3.xyz.z, mad(r0.xyz.y, r3.xyz.y, r0.xyz.x * r3.xyz.x)), 0.0f, 1.0f);
    r1 = _493;
    float4 _509 = r0;
    _509.x = mad(r0.xyz.z, shader_in[1].xyz.z, mad(r0.xyz.y, shader_in[1].xyz.y, r0.xyz.x * shader_in[1].xyz.x));
    r0 = _509;
    float4 _519 = r0;
    _519.x = clamp((r0.x * asfloat(1056964608u)) + asfloat(1056964608u), 0.0f, 1.0f);
    r0 = _519;
    r3 = tex2Dbias(SPIRV_Cross_Combinedt1s1, float4(shader_in[4].zwzz.xy, 0.0, asfloat(1073741824u)));
    ...
    r4 = tex2Dbias(SPIRV_Cross_Combinedt0s0, float4(shader_in[3].xyxx.xy, 0.0, asfloat(1073741824u)));
    ...
    r3 = tex2Dbias(SPIRV_Cross_Combinedt2s2, float4(shader_in[5].xyxx.xy, 0.0, asfloat(1073741824u)));
    ...
    r3 = tex2Dbias(SPIRV_Cross_Combinedt3s3, float4(shader_in[3].zwzz.xy, 0.0, asfloat(1073741824u)));
    ...
    r2 = tex2D(SPIRV_Cross_Combinedt9s9, shader_in[4].xyxx.xy);
    ...
    float4 _858 = r0;
    _858.w = (-shader_in[2].w) + asfloat(1065353216u);
    r0 = _858;
    float3 _864 = r0.xyz * r0.www;
    r0 = float4(_864.x, _864.y, _864.z, r0.w);
    float3 _881 = (shader_in[2].www * float3(cb0_m[4].x, cb0_m[4].y, cb0_m[4].z)) + r0.xyz;
    r0 = float4(_881.x, _881.y, _881.z, r0.w);
    float4 _887 = r0;
    _887.w = shader_in[5].z;
    r0 = _887;
...
void frag_main()
{
    ...
    float4 _915 = gl_FragCoord;
    _915.w = 1.0f / _915.w;
    shader_in[0] = float4(_915.xy.x, _915.xy.y, shader_in[0].z, shader_in[0].w);
    ps_main();
}
