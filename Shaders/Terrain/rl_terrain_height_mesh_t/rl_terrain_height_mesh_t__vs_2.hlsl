...
void vs_main()
{
    ...
    _588.z = rsqrt(r0.z);
    r0 = _588;
    float3 _594 = r0.zzz * r1.xyz;
    r1 = float4(_594.x, _594.y, _594.z, r1.w);
    float3 _610 = o3;
    _610.z = mad(r1.xyz.z, r2.xyz.z, mad(r1.xyz.y, r2.xyz.y, r1.xyz.x * r2.xyz.x));
    o3 = _610;
    float2 _616 = -r3.xz;
    float3 _623 = o3;
    _623.y = mad(r1.zy.y, _616.y, r1.zy.x * _616.x);
    o3 = _623;
    float3 _638 = o3;
    _638.x = mad(r1.xyz.z, r4.xyz.z, mad(r1.xyz.y, r4.xyz.y, r1.xyz.x * r4.xyz.x));
    o3 = _638;
    float2 _651 = (r0.xy * asfloat(uint2(989872160u, 989872160u))) + float2(cb2_m[4].z, cb2_m[4].w);
    r0 = float4(r0.x, r0.y, _651.x, _651.y);
    float2 _662 = r0.zw * float2(cb2_m[4].x, cb2_m[4].y);
    o4 = float4(_662.x, _662.y, o4.z, o4.w);
    float2 _676 = (r0.xy * asfloat(uint2(989872160u, 989872160u))) + float2(cb2_m[7].z, cb2_m[7].w);
    r0 = float4(r0.x, r0.y, _676.x, _676.y);
    float2 _687 = r0.zw * float2(cb2_m[7].x, cb2_m[7].y);
    o4 = float4(o4.x, o4.y, _687.x, _687.y);
    float2 _697 = (r0.xy * asfloat(uint2(989872160u, 989872160u))) + asfloat(uint2(1090519040u, 1090519040u));
    r0 = float4(r0.x, r0.y, _697.x, _697.y);
    float2 _711 = (r0.xy * asfloat(uint2(989872160u, 989872160u))) + float2(cb2_m[5].z, cb2_m[5].w);
    r0 = float4(_711.x, _711.y, r0.z, r0.w);
    float2 _722 = r0.xy * float2(cb2_m[5].x, cb2_m[5].y);
    o5 = float4(o5.x, o5.y, _722.x, _722.y);
    float2 _734 = r0.zw + (-float2(cb6_m[4].x, cb6_m[4].z));
    r0 = float4(_734.x, _734.y, r0.z, r0.w);
    float2 _746 = (r0.xy * asfloat(uint2(1065320448u, 1065320448u))) + asfloat(uint2(981467136u, 981467136u));
    o5 = float4(_746.x, _746.y, o5.z, o5.w);
}

void vert_main()
{
    float2 _751 = asfloat(v0);
    shader_in[0] = float4(_751.x, _751.y, shader_in[0].z, shader_in[0].w);
