...
void vs_main()
{
    ...
    o2 = _540;
    float2 _546 = float2(asint(shader_in[1].xy));
    r0 = float4(_546.x, _546.y, r0.z, r0.w);
    float4 _554 = r0;
    _554.y = r0.y * asfloat(981467136u);
    r0 = _554;
    float2 _569 = (r0.xx * asfloat(uint2(981467136u, 981467136u))) + float2(cb2_m[6].x, cb2_m[6].y);
    o3 = float4(_569.x, o3.y, _569.y, o3.w);
    o3 = float4(o3.x, r0.yy.x, o3.z, r0.yy.y);
}
