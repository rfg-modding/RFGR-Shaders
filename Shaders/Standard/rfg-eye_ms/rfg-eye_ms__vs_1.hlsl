...
void vs_main()
{
    ...
    r4 = float4(_543.x, _543.y, _543.z, r4.w);
    float3 _560 = o2;
    _560.y = mad(r4.xyz.z, r3.xyz.z, mad(r4.xyz.y, r3.xyz.y, r4.xyz.x * r3.xyz.x));
    o2 = _560;
    float3 _575 = o2;
    _575.z = mad(r4.xyz.z, r1.xyz.z, mad(r4.xyz.y, r1.xyz.y, r4.xyz.x * r1.xyz.x));
    o2 = _575;
    float3 _590 = o2;
    _590.x = mad(r4.xyz.z, r2.xyz.z, mad(r4.xyz.y, r2.xyz.y, r4.xyz.x * r2.xyz.x));
    o2 = _590;
    float3 _603 = (-r0.xyz) + float3(cb1_m[0].x, cb1_m[0].y, cb1_m[0].z);
    ...
    float4 _630 = r0;
    _630.w = mad(r4.xz.y, r4.xz.y, r4.xz.x * r4.xz.x);
    r0 = _630;
    float4 _635 = r0;
    _635.w = sqrt(r0.w);
    r0 = _635;
    float4 _645 = r0;
    _645.w = asfloat((asfloat(0u) < r0.w) ? 4294967295u : 0u);
    r0 = _645;
    float4 _652 = r0;
    _652.w = asfloat(asuint(r0.w) & 1065353216u);
    r0 = _652;
    float4 _655 = r4;
    _655.w = asfloat(0u);
    r4 = _655;
    float3 _662 = (-r4.xyz) + r4.xwz;
    r5 = float4(_662.x, _662.y, _662.z, r5.w);
    float3 _673 = (r0.www * r5.xyz) + r4.xyz;
    r4 = float4(_673.x, _673.y, _673.z, r4.w);
    float4 _689 = r0;
    _689.w = mad(r4.xyz.z, r4.xyz.z, mad(r4.xyz.y, r4.xyz.y, r4.xyz.x * r4.xyz.x));
    r0 = _689;
    float4 _694 = r0;
    _694.w = rsqrt(r0.w);
    r0 = _694;
    float3 _700 = r0.www * r4.xyz;
    r4 = float4(_700.x, _700.y, _700.z, r4.w);
    float3 _716 = o3;
    _716.z = mad(r4.xyz.z, r1.xyz.z, mad(r4.xyz.y, r1.xyz.y, r4.xyz.x * r1.xyz.x));
    o3 = _716;
    float3 _731 = o3;
    _731.x = mad(r4.xyz.z, r2.xyz.z, mad(r4.xyz.y, r2.xyz.y, r4.xyz.x * r2.xyz.x));
    o3 = _731;
    float3 _746 = o3;
    _746.y = mad(r4.xyz.z, r3.xyz.z, mad(r4.xyz.y, r3.xyz.y, r4.xyz.x * r3.xyz.x));
    o3 = _746;
    float4 _755 = r0;
    ...
    o4 = _860;
    float3 _869 = float3(cb1_m[1].x, cb1_m[1].y, cb1_m[1].z);
    o4 = float4(_869.x, _869.y, _869.z, o4.w);
}

void vert_main()
{
    shader_in[0] = float4(v0.x, v0.y, v0.z, shader_in[0].w);
    float2 _878 = asfloat(v1);
    shader_in[1] = float4(_878.x, _878.y, shader_in[1].z, shader_in[1].w);
