...
void ps_main()
{
    ...
    float3 _635 = (r4.xyz * r1.zzz) + (-r1.xyw);
    r4 = float4(_635.x, _635.y, _635.z, r4.w);
    float4 _643 = r1;
    _643.z = (-r1.z) + asfloat(1065353216u);
    r1 = _643;
    float4 _655 = r1;
    _655.z = ((-r1.z) * cb2_m[6].x) + asfloat(1065353216u);
    r1 = _655;
    r5 = tex2D(SPIRV_Cross_Combinedt2s2, shader_in[1].xyxx.xy);
    float3 _675 = r5.xyz * float3(cb2_m[4].x, cb2_m[4].y, cb2_m[4].z);
    r5 = float4(_675.x, _675.y, _675.z, r5.w);
    float3 _685 = (r5.xxx * r4.xyz) + r1.xyw;
    r1 = float4(_685.x, _685.y, r1.z, _685.z);
    float4 _701 = r2;
    _701.w = mad(r2.xyz.z, r2.xyz.z, mad(r2.xyz.y, r2.xyz.y, r2.xyz.x * r2.xyz.x));
    r2 = _701;
    float4 _706 = r2;
    _706.w = rsqrt(r2.w);
    r2 = _706;
    float3 _712 = r2.www * r2.xyz;
    r2 = float4(_712.x, _712.y, _712.z, r2.w);
    float4 _728 = r0;
    _728.x = mad(r0.xyz.z, r2.xyz.z, mad(r0.xyz.y, r2.xyz.y, r0.xyz.x * r2.xyz.x));
    r0 = _728;
    float4 _734 = r0;
    _734.x = max(r0.x, asfloat(0u));
    r0 = _734;
    float4 _739 = r0;
    _739.x = log2(r0.x);
    r0 = _739;
    float4 _747 = r0;
    _747.x = r0.x * cb2_m[6].y;
    r0 = _747;
    float4 _752 = r0;
    _752.x = exp2(r0.x);
    r0 = _752;
    float4 _760 = r0;
    _760.x = r0.x * cb2_m[5].w;
    r0 = _760;
    float3 _766 = r0.xxx * r5.xyz;
    r0 = float4(_766.x, _766.y, _766.z, r0.w);
    float3 _773 = r1.zzz * r0.xyz;
    r0 = float4(_773.x, _773.y, _773.z, r0.w);
    float3 _783 = (r0.xyz * r0.www) + r1.xyw;
    ...
    r1 = float4(_808.x, _808.y, r1.z, r1.w);
    r1 = tex2D(SPIRV_Cross_Combinedt15s15, r1.xyxx.xy);
    float3 _822 = r0.xyz * r1.yyy;
    r0 = float4(_822.x, _822.y, _822.z, r0.w);
    float4 _831 = r0;
    _831.w = (-shader_in[4].w) + asfloat(1065353216u);
    r0 = _831;
    float3 _837 = r0.xyz * r0.www;
    r3 = float4(_837.x, _837.y, _837.z, r3.w);
...
void frag_main()
{
    ...
    shader_in[4] = v4;
    float4 _868 = gl_FragCoord;
    _868.w = 1.0f / _868.w;
    shader_in[0] = float4(_868.xy.x, _868.xy.y, shader_in[0].z, shader_in[0].w);
    ps_main();
}
