...
void vs_main()
{
    ...
    float3 _614 = o2;
    _614.x = mad(_602.z, r2.xyz.z, mad(_602.y, r2.xyz.y, _602.x * r2.xyz.x));
    o2 = _614;
    float4 _618 = o3;
    _618.x = r2.y;
    o3 = _618;
    float4 _627 = r0;
    _627.w = r0.y * cb0_m[13].x;
    r0 = _627;
    float4 _634 = r1;
    _634.x = r0.w * asfloat(3216550459u);
    r1 = _634;
    float4 _639 = r1;
    _639.x = exp2(r1.x);
    r1 = _639;
    float4 _646 = r1;
    _646.x = (-r1.x) + asfloat(1065353216u);
    r1 = _646;
    float4 _653 = r0;
    _653.w = r1.x / r0.w;
    r0 = _653;
    float4 _665 = r1;
    _665.x = asfloat((asfloat(1008981770u) < abs(r0.y)) ? 4294967295u : 0u);
    r1 = _665;
    float4 _680 = r0;
    _680.x = mad(r0.xyz.z, r0.xyz.z, mad(r0.xyz.y, r0.xyz.y, r0.xyz.x * r0.xyz.x));
    r0 = _680;
    float4 _685 = r0;
    _685.x = sqrt(r0.x);
    r0 = _685;
    ...
    r0 = _693;
    float4 _703 = r0;
    _703.y = (asuint(r1.x) != 0u) ? r0.w : asfloat(1065353216u);
    r0 = _703;
    float4 _715 = r0;
    _715.x = (r0.y * r0.x) + (-cb0_m[13].w);
    r0 = _715;
    float4 _721 = r0;
    _721.x = exp2(-r0.x);
    r0 = _721;
    float4 _727 = r0;
    _727.x = min(r0.x, asfloat(1065353216u));
    r0 = _727;
    float4 _734 = o3;
    _734.w = (-r0.x) + asfloat(1065353216u);
    o3 = _734;
}
...
void vert_main()
{
    ...
    float2 _742 = asfloat(v1);
    shader_in[1] = float4(_742.x, _742.y, shader_in[1].z, shader_in[1].w);
