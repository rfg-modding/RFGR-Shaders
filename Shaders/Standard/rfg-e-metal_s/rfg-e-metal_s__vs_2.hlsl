...
void vs_main()
{
    ...
    o2 = _626;
    float2 _633 = float2(asint(shader_in[1].xy));
    r0 = float4(_633.x, _633.y, r0.z, r0.w);
    float2 _644 = r0.xy * float2(cb2_m[2].x, cb2_m[2].y);
    r0 = float4(_644.x, _644.y, r0.z, r0.w);
    float2 _653 = r0.xy * asfloat(uint2(981467136u, 981467136u));
    o3 = float4(_653.x, _653.y, o3.z, o3.w);
    ...
    o3 = float4(o3.x, o3.y, _667.x, _667.y);
}
