...
void vs_main()
{
    ...
    float4 _355 = r3;
    _355.x = mad(shader_in[5].xyz.z, r2.xyz.z, mad(shader_in[5].xyz.y, r2.xyz.y, shader_in[5].xyz.x * r2.xyz.x));
    r3 = _355;
    float4 _371 = r3;
    _371.y = mad(shader_in[6].xyz.z, r2.xyz.z, mad(shader_in[6].xyz.y, r2.xyz.y, shader_in[6].xyz.x * r2.xyz.x));
    r3 = _371;
    float4 _387 = r3;
    _387.z = mad(shader_in[7].xyz.z, r2.xyz.z, mad(shader_in[7].xyz.y, r2.xyz.y, shader_in[7].xyz.x * r2.xyz.x));
    r3 = _387;
    float4 _402 = r0;
    ...
    o3 = float4(o3.x, o3.y, _615.x, _615.y);
}
