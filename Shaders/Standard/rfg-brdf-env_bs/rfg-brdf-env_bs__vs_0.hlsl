...
void vs_main()
{
    ...
    o3 = _720;
    float2 _727 = float2(asint(shader_in[1].xy));
    r0 = float4(_727.x, _727.y, r0.z, r0.w);
    float2 _738 = r0.xy * float2(cb2_m[7].x, cb2_m[7].y);
    r0 = float4(_738.x, _738.y, r0.z, r0.w);
    float2 _747 = r0.xy * asfloat(uint2(981467136u, 981467136u));
    o4 = float4(_747.x, _747.y, o4.z, o4.w);
    float2 _754 = float2(asint(shader_in[2].xy));
