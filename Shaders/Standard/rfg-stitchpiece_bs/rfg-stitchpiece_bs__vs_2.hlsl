...
void vs_main()
{
    ...
    float2 _611 = r0.xy * float2(cb2_m[1].y, cb2_m[1].z);
    r0 = float4(_611.x, _611.y, r0.z, r0.w);
    float2 _617 = r0.xy * asfloat(uint2(981467136u, 981467136u));
    o4 = float4(o4.x, o4.y, _617.x, _617.y);
    float2 _624 = float2(asint(shader_in[1].xy));
    r0 = float4(_624.x, _624.y, r0.z, r0.w);
    float2 _630 = r0.xy * asfloat(uint2(981467136u, 981467136u));
    o4 = float4(_630.x, _630.y, o4.z, o4.w);
}

void vert_main()
{
    shader_in[0] = float4(v0.x, v0.y, v0.z, shader_in[0].w);
    float2 _639 = asfloat(v1);
    shader_in[1] = float4(_639.x, _639.y, shader_in[1].z, shader_in[1].w);
    float2 _644 = asfloat(v2);
    shader_in[2] = float4(_644.x, _644.y, shader_in[2].z, shader_in[2].w);
    float2 _649 = asfloat(v3);
    shader_in[3] = float4(_649.x, _649.y, shader_in[3].z, shader_in[3].w);
