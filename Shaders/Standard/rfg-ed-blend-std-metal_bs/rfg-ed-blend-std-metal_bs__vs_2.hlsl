...
void vs_main()
{
    ...
    float2 _262 = r1.xy * float2(cb2_m[3].z, cb2_m[3].w);
    ...
    float2 _623 = r0.xy * float2(cb2_m[4].x, cb2_m[4].y);
    r0 = float4(_623.x, _623.y, r0.z, r0.w);
    float2 _629 = r0.xy * asfloat(uint2(981467136u, 981467136u));
    o4 = float4(_629.x, _629.y, o4.z, o4.w);
