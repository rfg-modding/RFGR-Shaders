...
void vs_main()
{
    ...
    float2 _647 = r0.xy * float2(cb2_m[7].x, cb2_m[7].y);
    r0 = float4(_647.x, _647.y, r0.z, r0.w);
    float2 _656 = r0.xy * asfloat(uint2(981467136u, 981467136u));
    o3 = float4(_656.x, _656.y, o3.z, o3.w);
    float2 _663 = float2(asint(shader_in[2].xy));
    r0 = float4(_663.x, _663.y, r0.z, r0.w);
    float2 _669 = r0.xy * asfloat(uint2(981467136u, 981467136u));
    o3 = float4(o3.x, o3.y, _669.x, _669.y);
}
...
void vert_main()
{
    ...
    float2 _683 = asfloat(v2);
    shader_in[2] = float4(_683.x, _683.y, shader_in[2].z, shader_in[2].w);
