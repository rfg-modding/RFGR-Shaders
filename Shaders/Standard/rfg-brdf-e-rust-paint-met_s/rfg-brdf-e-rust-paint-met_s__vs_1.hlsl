...
void vs_main()
{
    ...
    float2 _838 = r0.xy * float2(cb2_m[7].x, cb2_m[7].y);
    r0 = float4(_838.x, _838.y, r0.z, r0.w);
    float2 _847 = r0.xy * asfloat(uint2(981467136u, 981467136u));
    o4 = float4(_847.x, _847.y, o4.z, o4.w);
    float2 _854 = float2(asint(shader_in[2].xy));
...
void vert_main()
{
    ...
    float2 _874 = asfloat(v2);
    shader_in[2] = float4(_874.x, _874.y, shader_in[2].z, shader_in[2].w);
