...
void vs_main()
{
    ...
    float2 _836 = r0.xy * float2(cb2_m[3].x, cb2_m[3].y);
    r0 = float4(_836.x, _836.y, r0.z, r0.w);
    float2 _845 = r0.xy * asfloat(uint2(981467136u, 981467136u));
    o4 = float4(_845.x, _845.y, o4.z, o4.w);
    float2 _853 = float2(asint(shader_in[4].xy));
...
void vert_main()
{
    ...
    shader_in[3] = v3;
    float2 _879 = asfloat(v4);
    shader_in[4] = float4(_879.x, _879.y, shader_in[4].z, shader_in[4].w);
    vs_main();
    gl_Position = o0;
    gl_PointSize = 1.0f;
