...
void vs_main()
{
    ...
    float2 _789 = r0.xy * float2(cb2_m[3].x, cb2_m[3].y);
    r0 = float4(_789.x, _789.y, r0.z, r0.w);
    float2 _798 = r0.xy * asfloat(uint2(981467136u, 981467136u));
    o4 = float4(_798.x, _798.y, o4.z, o4.w);
    float2 _806 = float2(asint(shader_in[4].xy));
    r0 = float4(_806.x, _806.y, r0.z, r0.w);
    float2 _812 = r0.xy * asfloat(uint2(981467136u, 981467136u));
    o4 = float4(o4.x, o4.y, _812.x, _812.y);
}
...
void vert_main()
{
    ...
    shader_in[3] = v3;
    float2 _832 = asfloat(v4);
    shader_in[4] = float4(_832.x, _832.y, shader_in[4].z, shader_in[4].w);
    vs_main();
    gl_Position = o0;
    gl_PointSize = 1.0f;
