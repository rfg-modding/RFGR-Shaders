...
void vs_main()
{
    ...
    o4 = _568;
    float3 _583 = o3;
    _583.z = mad(r4.xyz.z, r1.xyz.z, mad(r4.xyz.y, r1.xyz.y, r4.xyz.x * r1.xyz.x));
    o3 = _583;
    float4 _587 = o4;
    _587.z = r1.y;
    o4 = _587;
    float3 _602 = o3;
    _602.y = mad(r4.xyz.z, r3.xyz.z, mad(r4.xyz.y, r3.xyz.y, r4.xyz.x * r3.xyz.x));
    o3 = _602;
    float4 _606 = o4;
    _606.y = r3.y;
    o4 = _606;
    float4 _615 = r0;
    _615.w = r0.y * cb0_m[13].x;
    r0 = _615;
    float4 _622 = r1;
    _622.x = r0.w * asfloat(3216550459u);
    r1 = _622;
    float4 _627 = r1;
    _627.x = exp2(r1.x);
    r1 = _627;
    float4 _634 = r1;
    _634.x = (-r1.x) + asfloat(1065353216u);
    r1 = _634;
    float4 _641 = r0;
    _641.w = r1.x / r0.w;
    r0 = _641;
    float4 _653 = r1;
    _653.x = asfloat((asfloat(1008981770u) < abs(r0.y)) ? 4294967295u : 0u);
    r1 = _653;
    float4 _668 = r0;
    _668.x = mad(r0.xyz.z, r0.xyz.z, mad(r0.xyz.y, r0.xyz.y, r0.xyz.x * r0.xyz.x));
    r0 = _668;
    float4 _673 = r0;
    _673.x = sqrt(r0.x);
    r0 = _673;
    float4 _681 = r0;
    _681.x = r0.x * cb0_m[13].y;
    r0 = _681;
    float4 _691 = r0;
    _691.y = (asuint(r1.x) != 0u) ? r0.w : asfloat(1065353216u);
    r0 = _691;
    float4 _703 = r0;
    _703.x = (r0.y * r0.x) + (-cb0_m[13].w);
    r0 = _703;
    float4 _709 = r0;
    _709.x = exp2(-r0.x);
    r0 = _709;
    float4 _715 = r0;
    _715.x = min(r0.x, asfloat(1065353216u));
    r0 = _715;
    float4 _722 = o4;
    _722.w = (-r0.x) + asfloat(1065353216u);
    o4 = _722;
    ...
    o5 = float4(_734.x, _734.y, o5.z, o5.w);
    float2 _741 = float2(asint(shader_in[3].xy));
    r0 = float4(_741.x, _741.y, r0.z, r0.w);
    float2 _747 = r0.xy * asfloat(uint2(981467136u, 981467136u));
    o5 = float4(o5.x, o5.y, _747.x, _747.y);
}

void vert_main()
{
    shader_in[0] = float4(v0.x, v0.y, v0.z, shader_in[0].w);
    float2 _756 = asfloat(v1);
    shader_in[1] = float4(_756.x, _756.y, shader_in[1].z, shader_in[1].w);
    float2 _761 = asfloat(v2);
    shader_in[2] = float4(_761.x, _761.y, shader_in[2].z, shader_in[2].w);
    float2 _766 = asfloat(v3);
    shader_in[3] = float4(_766.x, _766.y, shader_in[3].z, shader_in[3].w);
