...
void vs_main()
{
    ...
    o4 = _649;
    float2 _656 = float2(asint(shader_in[4].xy));
    r1 = float4(_656.x, _656.y, r1.z, r1.w);
    o3 = r1.xy * asfloat(uint2(981467136u, 981467136u));
    float4 _673 = r0;
    _673.w = r0.y * cb0_m[13].x;
    r0 = _673;
    float4 _680 = r1;
    _680.x = r0.w * asfloat(3216550459u);
    r1 = _680;
    float4 _685 = r1;
    _685.x = exp2(r1.x);
    r1 = _685;
    float4 _692 = r1;
    _692.x = (-r1.x) + asfloat(1065353216u);
    r1 = _692;
    float4 _699 = r0;
    _699.w = r1.x / r0.w;
    r0 = _699;
    float4 _711 = r1;
    _711.x = asfloat((asfloat(1008981770u) < abs(r0.y)) ? 4294967295u : 0u);
    r1 = _711;
    float4 _726 = r0;
    _726.x = mad(r0.xyz.z, r0.xyz.z, mad(r0.xyz.y, r0.xyz.y, r0.xyz.x * r0.xyz.x));
    r0 = _726;
    float4 _731 = r0;
    _731.x = sqrt(r0.x);
    r0 = _731;
    float4 _739 = r0;
    _739.x = r0.x * cb0_m[13].y;
    r0 = _739;
    float4 _749 = r0;
    _749.y = (asuint(r1.x) != 0u) ? r0.w : asfloat(1065353216u);
    r0 = _749;
    float4 _761 = r0;
    _761.x = (r0.y * r0.x) + (-cb0_m[13].w);
    r0 = _761;
    float4 _767 = r0;
    _767.x = exp2(-r0.x);
    r0 = _767;
    float4 _773 = r0;
    _773.x = min(r0.x, asfloat(1065353216u));
    r0 = _773;
    float4 _780 = o4;
    _780.w = (-r0.x) + asfloat(1065353216u);
    o4 = _780;
    float2 _786 = float2(asint(shader_in[1].xy));
    r0 = float4(_786.x, _786.y, r0.z, r0.w);
    float2 _792 = r0.xy * asfloat(uint2(981467136u, 981467136u));
    o5 = float4(_792.x, _792.y, o5.z, o5.w);
    float2 _800 = float2(asint(shader_in[5].xy));
...
void vert_main()
{
    ...
    float2 _831 = asfloat(v5);
    shader_in[5] = float4(_831.x, _831.y, shader_in[5].z, shader_in[5].w);
    shader_in[6] = v6;
    shader_in[7] = v7;
    shader_in[8] = v8;
    vs_main();
