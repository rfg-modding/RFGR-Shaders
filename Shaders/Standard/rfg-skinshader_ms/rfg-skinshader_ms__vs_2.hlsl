...
void vs_main()
{
    ...
    o2 = _564;
    float3 _579 = o3;
    _579.y = mad(r0.xyz.z, r3.xyz.z, mad(r0.xyz.y, r3.xyz.y, r0.xyz.x * r3.xyz.x));
    o3 = _579;
    ...
    o2 = _600;
    float3 _615 = o3;
    _615.z = mad(r0.xyz.z, r1.xyz.z, mad(r0.xyz.y, r1.xyz.y, r0.xyz.x * r1.xyz.x));
    o3 = _615;
    float3 _630 = o3;
    _630.x = mad(r0.xyz.z, r2.xyz.z, mad(r0.xyz.y, r2.xyz.y, r0.xyz.x * r2.xyz.x));
    o3 = _630;
    float3 _639 = float3(cb1_m[0].x, cb1_m[0].y, cb1_m[0].z);
    float3 _651 = o2;
    _651.x = mad(_639.z, r2.xyz.z, mad(_639.y, r2.xyz.y, _639.x * r2.xyz.x));
    o2 = _651;
}
