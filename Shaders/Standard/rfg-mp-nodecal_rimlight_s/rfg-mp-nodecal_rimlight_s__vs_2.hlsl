...
void vs_main()
{
    ...
    float3 _544 = o2;
    _544.z = mad(_532.z, r1.xyz.z, mad(_532.y, r1.xyz.y, _532.x * r1.xyz.x));
    o2 = _544;
    float3 _553 = float3(cb1_m[0].x, cb1_m[0].y, cb1_m[0].z);
    float3 _565 = o2;
    _565.x = mad(_553.z, r2.xyz.z, mad(_553.y, r2.xyz.y, _553.x * r2.xyz.x));
    o2 = _565;
    float4 _580 = r0;
    _580.w = mad(r0.xyz.z, r0.xyz.z, mad(r0.xyz.y, r0.xyz.y, r0.xyz.x * r0.xyz.x));
    r0 = _580;
    float4 _585 = r0;
    _585.w = rsqrt(r0.w);
    r0 = _585;
    float3 _591 = r0.www * r0.xyz;
    r0 = float4(_591.x, _591.y, _591.z, r0.w);
    float3 _607 = o3;
    _607.x = mad(r0.xyz.z, r2.xyz.z, mad(r0.xyz.y, r2.xyz.y, r0.xyz.x * r2.xyz.x));
    o3 = _607;
    float3 _622 = o3;
    _622.z = mad(r0.xyz.z, r1.xyz.z, mad(r0.xyz.y, r1.xyz.y, r0.xyz.x * r1.xyz.x));
    o3 = _622;
    float3 _637 = o3;
    _637.y = mad(r0.xyz.z, r3.xyz.z, mad(r0.xyz.y, r3.xyz.y, r0.xyz.x * r3.xyz.x));
    o3 = _637;
}
...
void vert_main()
{
    ...
    float2 _645 = asfloat(v1);
    shader_in[1] = float4(_645.x, _645.y, shader_in[1].z, shader_in[1].w);
