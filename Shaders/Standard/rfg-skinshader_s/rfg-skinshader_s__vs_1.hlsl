...
void vs_main()
{
    ...
    float3 _592 = o3;
    _592.x = mad(r4.xyz.z, r2.xyz.z, mad(r4.xyz.y, r2.xyz.y, r4.xyz.x * r2.xyz.x));
    o3 = _592;
    float3 _601 = float3(cb1_m[1].x, cb1_m[1].y, cb1_m[1].z);
    float4 _613 = o4;
    _613.x = mad(_601.z, r2.xyz.z, mad(_601.y, r2.xyz.y, _601.x * r2.xyz.x));
    o4 = _613;
    float3 _628 = o3;
    _628.z = mad(r4.xyz.z, r1.xyz.z, mad(r4.xyz.y, r1.xyz.y, r4.xyz.x * r1.xyz.x));
    o3 = _628;
    float3 _637 = float3(cb1_m[1].x, cb1_m[1].y, cb1_m[1].z);
    float4 _649 = o4;
    _649.z = mad(_637.z, r1.xyz.z, mad(_637.y, r1.xyz.y, _637.x * r1.xyz.x));
    o4 = _649;
    float3 _664 = o3;
    _664.y = mad(r4.xyz.z, r3.xyz.z, mad(r4.xyz.y, r3.xyz.y, r4.xyz.x * r3.xyz.x));
    o3 = _664;
    float3 _673 = float3(cb1_m[1].x, cb1_m[1].y, cb1_m[1].z);
    float4 _685 = o4;
    _685.y = mad(_673.z, r3.xyz.z, mad(_673.y, r3.xyz.y, _673.x * r3.xyz.x));
    o4 = _685;
    float4 _694 = r0;
...
void vert_main()
{
    ...
    float2 _809 = asfloat(v1);
    shader_in[1] = float4(_809.x, _809.y, shader_in[1].z, shader_in[1].w);
