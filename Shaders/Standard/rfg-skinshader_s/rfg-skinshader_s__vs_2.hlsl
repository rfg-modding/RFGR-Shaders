...
void vs_main()
{
    ...
    o2 = _523;
    float3 _538 = o3;
    _538.y = mad(r0.xyz.z, r3.xyz.z, mad(r0.xyz.y, r3.xyz.y, r0.xyz.x * r3.xyz.x));
    o3 = _538;
    ...
    o2 = _559;
    float3 _574 = o3;
    _574.z = mad(r0.xyz.z, r1.xyz.z, mad(r0.xyz.y, r1.xyz.y, r0.xyz.x * r1.xyz.x));
    o3 = _574;
    float3 _589 = o3;
    _589.x = mad(r0.xyz.z, r2.xyz.z, mad(r0.xyz.y, r2.xyz.y, r0.xyz.x * r2.xyz.x));
    o3 = _589;
    float3 _598 = float3(cb1_m[0].x, cb1_m[0].y, cb1_m[0].z);
    float3 _610 = o2;
    _610.x = mad(_598.z, r2.xyz.z, mad(_598.y, r2.xyz.y, _598.x * r2.xyz.x));
    o2 = _610;
}
