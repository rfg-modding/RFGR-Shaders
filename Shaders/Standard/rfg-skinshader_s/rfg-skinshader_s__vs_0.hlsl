...
void vs_main()
{
    ...
    float3 _596 = o3;
    _596.x = mad(r4.xyz.z, r2.xyz.z, mad(r4.xyz.y, r2.xyz.y, r4.xyz.x * r2.xyz.x));
    o3 = _596;
    float4 _600 = o4;
    _600.x = r2.y;
    o4 = _600;
    float3 _615 = o3;
    _615.z = mad(r4.xyz.z, r1.xyz.z, mad(r4.xyz.y, r1.xyz.y, r4.xyz.x * r1.xyz.x));
    o3 = _615;
    float4 _619 = o4;
    _619.z = r1.y;
    o4 = _619;
    float3 _634 = o3;
    _634.y = mad(r4.xyz.z, r3.xyz.z, mad(r4.xyz.y, r3.xyz.y, r4.xyz.x * r3.xyz.x));
    o3 = _634;
    float4 _638 = o4;
    _638.y = r3.y;
    o4 = _638;
    float4 _647 = r0;
    _647.w = r0.y * cb0_m[13].x;
    r0 = _647;
    float4 _654 = r1;
    _654.x = r0.w * asfloat(3216550459u);
    r1 = _654;
    float4 _659 = r1;
    _659.x = exp2(r1.x);
    r1 = _659;
    float4 _666 = r1;
    _666.x = (-r1.x) + asfloat(1065353216u);
    r1 = _666;
    float4 _673 = r0;
    _673.w = r1.x / r0.w;
    r0 = _673;
    float4 _685 = r1;
    _685.x = asfloat((asfloat(1008981770u) < abs(r0.y)) ? 4294967295u : 0u);
    r1 = _685;
    float4 _700 = r0;
    _700.x = mad(r0.xyz.z, r0.xyz.z, mad(r0.xyz.y, r0.xyz.y, r0.xyz.x * r0.xyz.x));
    r0 = _700;
    float4 _705 = r0;
    _705.x = sqrt(r0.x);
    r0 = _705;
    float4 _713 = r0;
    _713.x = r0.x * cb0_m[13].y;
    r0 = _713;
    float4 _723 = r0;
    _723.y = (asuint(r1.x) != 0u) ? r0.w : asfloat(1065353216u);
    r0 = _723;
    float4 _735 = r0;
    _735.x = (r0.y * r0.x) + (-cb0_m[13].w);
    r0 = _735;
    float4 _741 = r0;
    _741.x = exp2(-r0.x);
    r0 = _741;
    float4 _747 = r0;
    _747.x = min(r0.x, asfloat(1065353216u));
    r0 = _747;
    float4 _754 = o4;
    _754.w = (-r0.x) + asfloat(1065353216u);
    o4 = _754;
}
...
void vert_main()
{
    ...
    float2 _762 = asfloat(v1);
    shader_in[1] = float4(_762.x, _762.y, shader_in[1].z, shader_in[1].w);
