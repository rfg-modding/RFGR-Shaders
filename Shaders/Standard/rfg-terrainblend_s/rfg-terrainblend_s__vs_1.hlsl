...
void vs_main()
{
    ...
    o4 = _701;
    float2 _708 = float2(asint(shader_in[4].xy));
    r1 = float4(_708.x, _708.y, r1.z, r1.w);
    o3 = r1.xy * asfloat(uint2(981467136u, 981467136u));
    float4 _725 = r0;
    _725.w = r0.y * cb0_m[13].x;
    r0 = _725;
    float4 _732 = r1;
    _732.x = r0.w * asfloat(3216550459u);
    r1 = _732;
    float4 _737 = r1;
    _737.x = exp2(r1.x);
    r1 = _737;
    float4 _744 = r1;
    _744.x = (-r1.x) + asfloat(1065353216u);
    r1 = _744;
    float4 _751 = r0;
    _751.w = r1.x / r0.w;
    r0 = _751;
    float4 _763 = r1;
    _763.x = asfloat((asfloat(1008981770u) < abs(r0.y)) ? 4294967295u : 0u);
    r1 = _763;
    float4 _778 = r0;
    _778.x = mad(r0.xyz.z, r0.xyz.z, mad(r0.xyz.y, r0.xyz.y, r0.xyz.x * r0.xyz.x));
    r0 = _778;
    float4 _783 = r0;
    _783.x = sqrt(r0.x);
    r0 = _783;
    float4 _791 = r0;
    _791.x = r0.x * cb0_m[13].y;
    r0 = _791;
    float4 _801 = r0;
    _801.y = (asuint(r1.x) != 0u) ? r0.w : asfloat(1065353216u);
    r0 = _801;
    float4 _813 = r0;
    _813.x = (r0.y * r0.x) + (-cb0_m[13].w);
    r0 = _813;
    float4 _819 = r0;
    _819.x = exp2(-r0.x);
    r0 = _819;
    float4 _825 = r0;
    _825.x = min(r0.x, asfloat(1065353216u));
    r0 = _825;
    float4 _832 = o4;
    _832.w = (-r0.x) + asfloat(1065353216u);
    o4 = _832;
    float2 _838 = float2(asint(shader_in[1].xy));
    r0 = float4(_838.x, _838.y, r0.z, r0.w);
    float2 _844 = r0.xy * asfloat(uint2(981467136u, 981467136u));
    o5 = float4(_844.x, _844.y, o5.z, o5.w);
    float2 _852 = float2(asint(shader_in[5].xy));
...
void vert_main()
{
    ...
    float2 _883 = asfloat(v5);
    shader_in[5] = float4(_883.x, _883.y, shader_in[5].z, shader_in[5].w);
    vs_main();
    gl_Position = o0;
    gl_PointSize = 1.0f;
