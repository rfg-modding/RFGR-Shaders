...
void vs_main()
{
    ...
    r1 = float4(_661.x, _661.y, r1.z, r1.w);
    ...
    o5 = float4(_797.x, _797.y, o5.z, o5.w);
    float2 _805 = float2(asint(shader_in[5].xy));
...
void vert_main()
{
    ...
    float2 _836 = asfloat(v5);
    shader_in[5] = float4(_836.x, _836.y, shader_in[5].z, shader_in[5].w);
    vs_main();
    gl_Position = o0;
    gl_PointSize = 1.0f;
