...
void vs_main()
{
    ...
    float2 _295 = r1.xy * float2(cb2_m[0].x, cb2_m[0].y);
    r1 = float4(_295.x, _295.y, r1.z, r1.w);
    o1 = r1.xy * asfloat(uint2(981467136u, 981467136u));
    o2 = float3(cb1_m[0].x, cb1_m[0].y, cb1_m[0].z);
    float4 _326 = r0;
    _326.w = mad(r0.xyz.z, r0.xyz.z, mad(r0.xyz.y, r0.xyz.y, r0.xyz.x * r0.xyz.x));
    r0 = _326;
    float4 _331 = r0;
    _331.w = rsqrt(r0.w);
    r0 = _331;
...
void vert_main()
{
    ...
    float2 _344 = asfloat(v1);
    shader_in[1] = float4(_344.x, _344.y, shader_in[1].z, shader_in[1].w);
