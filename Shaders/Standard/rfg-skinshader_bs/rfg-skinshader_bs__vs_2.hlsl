...
void vs_main()
{
    ...
    o2 = _471;
    float3 _486 = o3;
    _486.y = mad(r0.xyz.z, r3.xyz.z, mad(r0.xyz.y, r3.xyz.y, r0.xyz.x * r3.xyz.x));
    o3 = _486;
    ...
    o2 = _507;
    float3 _522 = o3;
    _522.z = mad(r0.xyz.z, r1.xyz.z, mad(r0.xyz.y, r1.xyz.y, r0.xyz.x * r1.xyz.x));
    o3 = _522;
    float3 _537 = o3;
    _537.x = mad(r0.xyz.z, r2.xyz.z, mad(r0.xyz.y, r2.xyz.y, r0.xyz.x * r2.xyz.x));
    o3 = _537;
    float3 _546 = float3(cb1_m[0].x, cb1_m[0].y, cb1_m[0].z);
    float3 _558 = o2;
    _558.x = mad(_546.z, r2.xyz.z, mad(_546.y, r2.xyz.y, _546.x * r2.xyz.x));
    o2 = _558;
}
...
void vert_main()
{
    ...
    float2 _566 = asfloat(v1);
    shader_in[1] = float4(_566.x, _566.y, shader_in[1].z, shader_in[1].w);
