...
void vs_main()
{
    ...
    float2 _755 = r0.xy * float2(cb2_m[3].x, cb2_m[3].y);
...
void vert_main()
{
    ...
    shader_in[3] = v3;
    float2 _806 = asfloat(v4);
    shader_in[4] = float4(_806.x, _806.y, shader_in[4].z, shader_in[4].w);
    float2 _811 = asfloat(v5);
    shader_in[5] = float4(_811.x, _811.y, shader_in[5].z, shader_in[5].w);
    shader_in[6] = v6;
    shader_in[7] = v7;
    shader_in[8] = v8;
    vs_main();
