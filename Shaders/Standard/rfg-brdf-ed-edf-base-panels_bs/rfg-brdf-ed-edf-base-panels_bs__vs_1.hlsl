...
void vs_main()
{
    ...
    float2 _802 = r0.xy * float2(cb2_m[6].z, cb2_m[6].w);
    ...
    float2 _822 = r0.xy * asfloat(uint2(981467136u, 981467136u));
...
void vert_main()
{
    ...
    shader_in[3] = v3;
    float2 _842 = asfloat(v4);
    shader_in[4] = float4(_842.x, _842.y, shader_in[4].z, shader_in[4].w);
    float2 _847 = asfloat(v5);
    shader_in[5] = float4(_847.x, _847.y, shader_in[5].z, shader_in[5].w);
    shader_in[6] = v6;
    shader_in[7] = v7;
    shader_in[8] = v8;
    vs_main();
