...
void vs_main()
{
    ...
    float3 _664 = o3;
    _664.z = mad(r4.xyz.z, r0.xyz.z, mad(r4.xyz.y, r0.xyz.y, r4.xyz.x * r0.xyz.x));
    o3 = _664;
    float4 _668 = o4;
    _668.z = r0.y;
    o4 = _668;
    float3 _683 = o3;
    _683.x = mad(r4.xyz.z, r2.xyz.z, mad(r4.xyz.y, r2.xyz.y, r4.xyz.x * r2.xyz.x));
    o3 = _683;
    float4 _687 = o4;
    _687.x = r2.y;
    o4 = _687;
    float3 _702 = o3;
    _702.y = mad(r4.xyz.z, r3.xyz.z, mad(r4.xyz.y, r3.xyz.y, r4.xyz.x * r3.xyz.x));
    o3 = _702;
    float4 _706 = o4;
    _706.y = r3.y;
    o4 = _706;
    float4 _715 = r0;
    _715.x = r1.y * cb0_m[13].x;
    r0 = _715;
    float4 _722 = r0;
    _722.y = r0.x * asfloat(3216550459u);
    r0 = _722;
    float4 _727 = r0;
    _727.y = exp2(r0.y);
    r0 = _727;
    float4 _734 = r0;
    _734.y = (-r0.y) + asfloat(1065353216u);
    r0 = _734;
    float4 _741 = r0;
    _741.x = r0.y / r0.x;
    r0 = _741;
    float4 _753 = r0;
    _753.y = asfloat((asfloat(1008981770u) < abs(r1.y)) ? 4294967295u : 0u);
    r0 = _753;
    float4 _768 = r0;
    _768.z = mad(r1.xyz.z, r1.xyz.z, mad(r1.xyz.y, r1.xyz.y, r1.xyz.x * r1.xyz.x));
    r0 = _768;
    float4 _773 = r0;
    _773.z = sqrt(r0.z);
    r0 = _773;
    float4 _781 = r0;
    _781.z = r0.z * cb0_m[13].y;
    r0 = _781;
    float4 _791 = r0;
    _791.x = (asuint(r0.y) != 0u) ? r0.x : asfloat(1065353216u);
    r0 = _791;
    float4 _803 = r0;
    _803.x = (r0.x * r0.z) + (-cb0_m[13].w);
    r0 = _803;
    float4 _809 = r0;
    _809.x = exp2(-r0.x);
    r0 = _809;
    float4 _815 = r0;
    _815.x = min(r0.x, asfloat(1065353216u));
    r0 = _815;
    float4 _822 = o4;
    _822.w = (-r0.x) + asfloat(1065353216u);
    o4 = _822;
}
