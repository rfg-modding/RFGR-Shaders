...
void vs_main()
{
    ...
    float4 _633 = r0;
    _633.w = mad(r4.xyz.z, r4.xyz.z, mad(r4.xyz.y, r4.xyz.y, r4.xyz.x * r4.xyz.x));
    r0 = _633;
    float4 _638 = r0;
    _638.w = rsqrt(r0.w);
    r0 = _638;
    float3 _644 = r0.www * r4.xyz;
    r4 = float4(_644.x, _644.y, _644.z, r4.w);
    float3 _660 = o3;
    _660.z = mad(r4.xyz.z, r1.xyz.z, mad(r4.xyz.y, r1.xyz.y, r4.xyz.x * r1.xyz.x));
    o3 = _660;
    float3 _669 = float3(cb1_m[1].x, cb1_m[1].y, cb1_m[1].z);
    float4 _681 = o4;
    _681.z = mad(_669.z, r1.xyz.z, mad(_669.y, r1.xyz.y, _669.x * r1.xyz.x));
    o4 = _681;
    float3 _696 = o3;
    _696.x = mad(r4.xyz.z, r2.xyz.z, mad(r4.xyz.y, r2.xyz.y, r4.xyz.x * r2.xyz.x));
    o3 = _696;
    float3 _705 = float3(cb1_m[1].x, cb1_m[1].y, cb1_m[1].z);
    float4 _717 = o4;
    _717.x = mad(_705.z, r2.xyz.z, mad(_705.y, r2.xyz.y, _705.x * r2.xyz.x));
    o4 = _717;
    float3 _732 = o3;
    _732.y = mad(r4.xyz.z, r3.xyz.z, mad(r4.xyz.y, r3.xyz.y, r4.xyz.x * r3.xyz.x));
    o3 = _732;
    float3 _741 = float3(cb1_m[1].x, cb1_m[1].y, cb1_m[1].z);
    float4 _753 = o4;
    _753.y = mad(_741.z, r3.xyz.z, mad(_741.y, r3.xyz.y, _741.x * r3.xyz.x));
    o4 = _753;
    float4 _762 = r0;
    _762.w = r0.y * cb0_m[13].x;
    r0 = _762;
    float4 _769 = r1;
    _769.x = r0.w * asfloat(3216550459u);
    r1 = _769;
    float4 _774 = r1;
    _774.x = exp2(r1.x);
    r1 = _774;
    float4 _781 = r1;
    _781.x = (-r1.x) + asfloat(1065353216u);
    r1 = _781;
    float4 _788 = r0;
    _788.w = r1.x / r0.w;
    r0 = _788;
    float4 _800 = r1;
    _800.x = asfloat((asfloat(1008981770u) < abs(r0.y)) ? 4294967295u : 0u);
    r1 = _800;
    float4 _815 = r0;
    _815.x = mad(r0.xyz.z, r0.xyz.z, mad(r0.xyz.y, r0.xyz.y, r0.xyz.x * r0.xyz.x));
    r0 = _815;
    float4 _820 = r0;
    _820.x = sqrt(r0.x);
    r0 = _820;
    float4 _828 = r0;
    _828.x = r0.x * cb0_m[13].y;
    r0 = _828;
    float4 _838 = r0;
    _838.y = (asuint(r1.x) != 0u) ? r0.w : asfloat(1065353216u);
    r0 = _838;
    float4 _850 = r0;
    _850.x = (r0.y * r0.x) + (-cb0_m[13].w);
    r0 = _850;
    float4 _856 = r0;
    _856.x = exp2(-r0.x);
    r0 = _856;
    float4 _862 = r0;
    _862.x = min(r0.x, asfloat(1065353216u));
    r0 = _862;
    float4 _869 = o4;
    _869.w = (-r0.x) + asfloat(1065353216u);
    o4 = _869;
}
