...
void vs_main()
{
    ...
    o2 = _471;
    float3 _480 = float3(cb1_m[0].x, cb1_m[0].y, cb1_m[0].z);
    float3 _492 = o2;
    _492.z = mad(_480.z, r1.xyz.z, mad(_480.y, r1.xyz.y, _480.x * r1.xyz.x));
    o2 = _492;
    float3 _501 = float3(cb1_m[0].x, cb1_m[0].y, cb1_m[0].z);
    float3 _513 = o2;
    _513.x = mad(_501.z, r2.xyz.z, mad(_501.y, r2.xyz.y, _501.x * r2.xyz.x));
    o2 = _513;
    float4 _528 = r0;
    _528.w = mad(r0.xyz.z, r0.xyz.z, mad(r0.xyz.y, r0.xyz.y, r0.xyz.x * r0.xyz.x));
    r0 = _528;
    float4 _533 = r0;
    _533.w = rsqrt(r0.w);
    r0 = _533;
    float3 _539 = r0.www * r0.xyz;
    r0 = float4(_539.x, _539.y, _539.z, r0.w);
    float3 _555 = o3;
    _555.x = mad(r0.xyz.z, r2.xyz.z, mad(r0.xyz.y, r2.xyz.y, r0.xyz.x * r2.xyz.x));
    o3 = _555;
    float3 _570 = o3;
    _570.z = mad(r0.xyz.z, r1.xyz.z, mad(r0.xyz.y, r1.xyz.y, r0.xyz.x * r1.xyz.x));
    o3 = _570;
    float3 _585 = o3;
    _585.y = mad(r0.xyz.z, r3.xyz.z, mad(r0.xyz.y, r3.xyz.y, r0.xyz.x * r3.xyz.x));
    o3 = _585;
}
...
void vert_main()
{
    ...
    float2 _593 = asfloat(v1);
    shader_in[1] = float4(_593.x, _593.y, shader_in[1].z, shader_in[1].w);
