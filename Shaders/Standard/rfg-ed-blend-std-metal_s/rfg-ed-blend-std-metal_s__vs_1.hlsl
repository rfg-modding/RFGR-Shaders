...
void vs_main()
{
    ...
    float2 _854 = r0.xy * float2(cb2_m[4].x, cb2_m[4].y);
    r0 = float4(_854.x, _854.y, r0.z, r0.w);
    float2 _860 = r0.xy * asfloat(uint2(981467136u, 981467136u));
    o5 = float4(_860.x, _860.y, o5.z, o5.w);
    float2 _868 = float2(asint(shader_in[5].xy));
    r0 = float4(_868.x, _868.y, r0.z, r0.w);
    float2 _879 = r0.xy * float2(cb2_m[3].z, cb2_m[3].w);
    r0 = float4(_879.x, _879.y, r0.z, r0.w);
    float2 _885 = r0.xy * asfloat(uint2(981467136u, 981467136u));
    o5 = float4(o5.x, o5.y, _885.x, _885.y);
}
...
void vert_main()
{
    ...
    shader_in[3] = v3;
    float2 _905 = asfloat(v4);
    shader_in[4] = float4(_905.x, _905.y, shader_in[4].z, shader_in[4].w);
    float2 _910 = asfloat(v5);
    shader_in[5] = float4(_910.x, _910.y, shader_in[5].z, shader_in[5].w);
    vs_main();
    gl_Position = o0;
    gl_PointSize = 1.0f;
