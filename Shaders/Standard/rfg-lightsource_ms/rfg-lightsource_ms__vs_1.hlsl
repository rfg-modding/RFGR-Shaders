...
void vs_main()
{
    ...
    _461.w = rsqrt(r0.w);
    r0 = _461;
    float3 _467 = r0.www * r2.xyz;
    o4 = float4(_467.x, _467.y, _467.z, o4.w);
    float4 _471 = o4;
    _471.w = asfloat(0u);
    o4 = _471;
    float4 _480 = r0;
    _480.w = r0.y * cb0_m[13].x;
    r0 = _480;
    float4 _487 = r1;
    _487.x = r0.w * asfloat(3216550459u);
    r1 = _487;
    float4 _492 = r1;
    _492.x = exp2(r1.x);
    r1 = _492;
    float4 _499 = r1;
    _499.x = (-r1.x) + asfloat(1065353216u);
    r1 = _499;
    float4 _506 = r0;
    _506.w = r1.x / r0.w;
    r0 = _506;
    float4 _518 = r1;
    _518.x = asfloat((asfloat(1008981770u) < abs(r0.y)) ? 4294967295u : 0u);
    r1 = _518;
    float4 _533 = r0;
    _533.x = mad(r0.xyz.z, r0.xyz.z, mad(r0.xyz.y, r0.xyz.y, r0.xyz.x * r0.xyz.x));
    r0 = _533;
    float4 _538 = r0;
    _538.x = sqrt(r0.x);
    r0 = _538;
    float4 _546 = r0;
    _546.x = r0.x * cb0_m[13].y;
    r0 = _546;
    float4 _556 = r0;
    _556.y = (asuint(r1.x) != 0u) ? r0.w : asfloat(1065353216u);
    r0 = _556;
    float4 _568 = r0;
    _568.x = (r0.y * r0.x) + (-cb0_m[13].w);
    r0 = _568;
    float4 _574 = r0;
    _574.x = exp2(-r0.x);
    r0 = _574;
    float4 _580 = r0;
    _580.x = min(r0.x, asfloat(1065353216u));
    r0 = _580;
    float4 _587 = o5;
    _587.w = (-r0.x) + asfloat(1065353216u);
    o5 = _587;
    float3 _596 = float3(cb1_m[1].x, cb1_m[1].y, cb1_m[1].z);
    o5 = float4(_596.x, _596.y, _596.z, o5.w);
}

void vert_main()
{
    shader_in[0] = float4(v0.x, v0.y, v0.z, shader_in[0].w);
    float2 _605 = asfloat(v1);
    shader_in[1] = float4(_605.x, _605.y, shader_in[1].z, shader_in[1].w);
