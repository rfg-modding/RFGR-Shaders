...
void vert_main()
{
    ...
    shader_in[3] = v3;
    float2 _689 = asfloat(v4);
    shader_in[4] = float4(_689.x, _689.y, shader_in[4].z, shader_in[4].w);
    vs_main();
    gl_Position = o0;
    gl_PointSize = 1.0f;
