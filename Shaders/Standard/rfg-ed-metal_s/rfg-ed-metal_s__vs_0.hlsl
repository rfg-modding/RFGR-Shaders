...
void vs_main()
{
    ...
    float2 _807 = r0.xy * float2(cb2_m[3].x, cb2_m[3].y);
    r0 = float4(_807.x, _807.y, r0.z, r0.w);
    float2 _813 = r0.xy * asfloat(uint2(981467136u, 981467136u));
    o5 = float4(_813.x, _813.y, o5.z, o5.w);
    float2 _821 = float2(asint(shader_in[5].xy));
    r0 = float4(_821.x, _821.y, r0.z, r0.w);
    float2 _832 = r0.xy * float2(cb2_m[2].z, cb2_m[2].w);
    r0 = float4(_832.x, _832.y, r0.z, r0.w);
    float2 _838 = r0.xy * asfloat(uint2(981467136u, 981467136u));
    o5 = float4(o5.x, o5.y, _838.x, _838.y);
}
...
void vert_main()
{
    ...
    shader_in[3] = v3;
    float2 _858 = asfloat(v4);
    shader_in[4] = float4(_858.x, _858.y, shader_in[4].z, shader_in[4].w);
    float2 _863 = asfloat(v5);
    shader_in[5] = float4(_863.x, _863.y, shader_in[5].z, shader_in[5].w);
    vs_main();
    gl_Position = o0;
    gl_PointSize = 1.0f;
