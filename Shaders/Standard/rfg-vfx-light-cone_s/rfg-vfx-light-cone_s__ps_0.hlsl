...
void ps_main()
{
    ...
    float4 _112 = r0;
    _112.w = clamp(mad(shader_in[2].xyz.z, shader_in[3].xyz.z, mad(shader_in[2].xyz.y, shader_in[3].xyz.y, shader_in[2].xyz.x * shader_in[3].xyz.x)), 0.0f, 1.0f);
    r0 = _112;
    ...
    float4 _137 = r0;
    _137.w = (-shader_in[3].w) + asfloat(1065353216u);
    r0 = _137;
    float3 _143 = r0.xyz * r0.www;
    r0 = float4(_143.x, _143.y, _143.z, r0.w);
    float4 _147 = r0;
    _147.w = asfloat(1065353216u);
    r0 = _147;
