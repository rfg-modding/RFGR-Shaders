...
void vs_main()
{
    ...
    float3 _557 = o2;
    _557.z = mad(_545.z, r1.xyz.z, mad(_545.y, r1.xyz.y, _545.x * r1.xyz.x));
    o2 = _557;
    float4 _561 = o3;
    _561.z = r1.y;
    o3 = _561;
    ...
    o3 = _702;
    float2 _708 = float2(asint(shader_in[2].xy));
    r0 = float4(_708.x, _708.y, r0.z, r0.w);
    float2 _719 = r0.xy * float2(cb2_m[1].y, cb2_m[1].z);
    r0 = float4(_719.x, _719.y, r0.z, r0.w);
    float2 _725 = r0.xy * asfloat(uint2(981467136u, 981467136u));
    o4 = float4(o4.x, o4.y, _725.x, _725.y);
    float2 _732 = float2(asint(shader_in[1].xy));
    r0 = float4(_732.x, _732.y, r0.z, r0.w);
    float2 _738 = r0.xy * asfloat(uint2(981467136u, 981467136u));
    o4 = float4(_738.x, _738.y, o4.z, o4.w);
}

void vert_main()
{
    shader_in[0] = float4(v0.x, v0.y, v0.z, shader_in[0].w);
    float2 _747 = asfloat(v1);
    shader_in[1] = float4(_747.x, _747.y, shader_in[1].z, shader_in[1].w);
    float2 _752 = asfloat(v2);
    shader_in[2] = float4(_752.x, _752.y, shader_in[2].z, shader_in[2].w);
    float2 _757 = asfloat(v3);
    shader_in[3] = float4(_757.x, _757.y, shader_in[3].z, shader_in[3].w);
