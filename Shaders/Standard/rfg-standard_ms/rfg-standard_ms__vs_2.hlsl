...
void vs_main()
{
    ...
    o2 = _573;
    float3 _588 = o3;
    _588.y = mad(r0.xyz.z, r3.xyz.z, mad(r0.xyz.y, r3.xyz.y, r0.xyz.x * r3.xyz.x));
    o3 = _588;
    float3 _597 = float3(cb1_m[0].x, cb1_m[0].y, cb1_m[0].z);
    float3 _609 = o2;
    _609.z = mad(_597.z, r1.xyz.z, mad(_597.y, r1.xyz.y, _597.x * r1.xyz.x));
    o2 = _609;
    float3 _624 = o3;
    _624.z = mad(r0.xyz.z, r1.xyz.z, mad(r0.xyz.y, r1.xyz.y, r0.xyz.x * r1.xyz.x));
    o3 = _624;
    float3 _639 = o3;
    _639.x = mad(r0.xyz.z, r2.xyz.z, mad(r0.xyz.y, r2.xyz.y, r0.xyz.x * r2.xyz.x));
    o3 = _639;
    float3 _648 = float3(cb1_m[0].x, cb1_m[0].y, cb1_m[0].z);
    float3 _660 = o2;
    _660.x = mad(_648.z, r2.xyz.z, mad(_648.y, r2.xyz.y, _648.x * r2.xyz.x));
    o2 = _660;
    float2 _666 = float2(asint(shader_in[2].xy));
    r0 = float4(_666.x, _666.y, r0.z, r0.w);
    float2 _677 = r0.xy * float2(cb2_m[2].y, cb2_m[2].z);
    r0 = float4(_677.x, _677.y, r0.z, r0.w);
    float2 _683 = r0.xy * asfloat(uint2(981467136u, 981467136u));
    o4 = float4(o4.x, o4.y, _683.x, _683.y);
    ...
    o4 = float4(_696.x, _696.y, o4.z, o4.w);
}

void vert_main()
{
    shader_in[0] = float4(v0.x, v0.y, v0.z, shader_in[0].w);
    float2 _705 = asfloat(v1);
    shader_in[1] = float4(_705.x, _705.y, shader_in[1].z, shader_in[1].w);
    float2 _710 = asfloat(v2);
    shader_in[2] = float4(_710.x, _710.y, shader_in[2].z, shader_in[2].w);
    float2 _715 = asfloat(v3);
    shader_in[3] = float4(_715.x, _715.y, shader_in[3].z, shader_in[3].w);
