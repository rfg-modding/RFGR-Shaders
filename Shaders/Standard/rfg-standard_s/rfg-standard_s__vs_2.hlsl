...
void vs_main()
{
    ...
    o2 = _532;
    float3 _547 = o3;
    _547.y = mad(r0.xyz.z, r3.xyz.z, mad(r0.xyz.y, r3.xyz.y, r0.xyz.x * r3.xyz.x));
    o3 = _547;
    float3 _556 = float3(cb1_m[0].x, cb1_m[0].y, cb1_m[0].z);
    float3 _568 = o2;
    _568.z = mad(_556.z, r1.xyz.z, mad(_556.y, r1.xyz.y, _556.x * r1.xyz.x));
    o2 = _568;
    float3 _583 = o3;
    _583.z = mad(r0.xyz.z, r1.xyz.z, mad(r0.xyz.y, r1.xyz.y, r0.xyz.x * r1.xyz.x));
    o3 = _583;
    float3 _598 = o3;
    ...
    float3 _619 = o2;
    _619.x = mad(_607.z, r2.xyz.z, mad(_607.y, r2.xyz.y, _607.x * r2.xyz.x));
    o2 = _619;
    float2 _625 = float2(asint(shader_in[2].xy));
    r0 = float4(_625.x, _625.y, r0.z, r0.w);
    float2 _636 = r0.xy * float2(cb2_m[2].y, cb2_m[2].z);
    r0 = float4(_636.x, _636.y, r0.z, r0.w);
    float2 _642 = r0.xy * asfloat(uint2(981467136u, 981467136u));
    o4 = float4(o4.x, o4.y, _642.x, _642.y);
    float2 _649 = float2(asint(shader_in[1].xy));
    r0 = float4(_649.x, _649.y, r0.z, r0.w);
    float2 _655 = r0.xy * asfloat(uint2(981467136u, 981467136u));
    o4 = float4(_655.x, _655.y, o4.z, o4.w);
}

void vert_main()
{
    shader_in[0] = float4(v0.x, v0.y, v0.z, shader_in[0].w);
    float2 _664 = asfloat(v1);
    shader_in[1] = float4(_664.x, _664.y, shader_in[1].z, shader_in[1].w);
    float2 _669 = asfloat(v2);
    shader_in[2] = float4(_669.x, _669.y, shader_in[2].z, shader_in[2].w);
    float2 _674 = asfloat(v3);
    shader_in[3] = float4(_674.x, _674.y, shader_in[3].z, shader_in[3].w);
