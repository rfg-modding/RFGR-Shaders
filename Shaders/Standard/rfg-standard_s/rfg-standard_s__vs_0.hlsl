...
void vs_main()
{
    ...
    o5 = float4(_786.x, _786.y, o5.z, o5.w);
    float2 _793 = float2(asint(shader_in[3].xy));
    r0 = float4(_793.x, _793.y, r0.z, r0.w);
    float2 _799 = r0.xy * asfloat(uint2(981467136u, 981467136u));
    o5 = float4(o5.x, o5.y, _799.x, _799.y);
}
...
void vert_main()
{
    ...
    float2 _813 = asfloat(v2);
    shader_in[2] = float4(_813.x, _813.y, shader_in[2].z, shader_in[2].w);
    float2 _818 = asfloat(v3);
    shader_in[3] = float4(_818.x, _818.y, shader_in[3].z, shader_in[3].w);
