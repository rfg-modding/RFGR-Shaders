...
void vs_main()
{
    ...
    float4 _544 = r0;
    _544.w = mad(r4.xyz.z, r4.xyz.z, mad(r4.xyz.y, r4.xyz.y, r4.xyz.x * r4.xyz.x));
    r0 = _544;
    float4 _549 = r0;
    _549.w = rsqrt(r0.w);
    r0 = _549;
    float3 _555 = r0.www * r4.xyz;
    r4 = float4(_555.x, _555.y, _555.z, r4.w);
    float3 _571 = o3;
    _571.x = mad(r4.xyz.z, r2.xyz.z, mad(r4.xyz.y, r2.xyz.y, r4.xyz.x * r2.xyz.x));
    o3 = _571;
    float4 _575 = o4;
    _575.x = r2.y;
    o4 = _575;
    float3 _590 = o3;
    _590.z = mad(r4.xyz.z, r1.xyz.z, mad(r4.xyz.y, r1.xyz.y, r4.xyz.x * r1.xyz.x));
    o3 = _590;
    float4 _594 = o4;
    _594.z = r1.y;
    o4 = _594;
    float3 _609 = o3;
    _609.y = mad(r4.xyz.z, r3.xyz.z, mad(r4.xyz.y, r3.xyz.y, r4.xyz.x * r3.xyz.x));
    o3 = _609;
    float4 _613 = o4;
    _613.y = r3.y;
    o4 = _613;
    float4 _622 = r0;
    _622.w = r0.y * cb0_m[13].x;
    r0 = _622;
    float4 _629 = r1;
    _629.x = r0.w * asfloat(3216550459u);
    r1 = _629;
    float4 _634 = r1;
    _634.x = exp2(r1.x);
    r1 = _634;
    float4 _641 = r1;
    _641.x = (-r1.x) + asfloat(1065353216u);
    r1 = _641;
    float4 _648 = r0;
    _648.w = r1.x / r0.w;
    r0 = _648;
    float4 _660 = r1;
    _660.x = asfloat((asfloat(1008981770u) < abs(r0.y)) ? 4294967295u : 0u);
    r1 = _660;
    float4 _675 = r0;
    _675.x = mad(r0.xyz.z, r0.xyz.z, mad(r0.xyz.y, r0.xyz.y, r0.xyz.x * r0.xyz.x));
    r0 = _675;
    float4 _680 = r0;
    _680.x = sqrt(r0.x);
    r0 = _680;
    float4 _688 = r0;
    _688.x = r0.x * cb0_m[13].y;
    r0 = _688;
    float4 _698 = r0;
    _698.y = (asuint(r1.x) != 0u) ? r0.w : asfloat(1065353216u);
    r0 = _698;
    float4 _710 = r0;
    _710.x = (r0.y * r0.x) + (-cb0_m[13].w);
    r0 = _710;
    float4 _716 = r0;
    _716.x = exp2(-r0.x);
    r0 = _716;
    float4 _722 = r0;
    _722.x = min(r0.x, asfloat(1065353216u));
    r0 = _722;
    float4 _729 = o4;
    _729.w = (-r0.x) + asfloat(1065353216u);
    o4 = _729;
}
...
void vert_main()
{
    ...
    float2 _737 = asfloat(v1);
    shader_in[1] = float4(_737.x, _737.y, shader_in[1].z, shader_in[1].w);
