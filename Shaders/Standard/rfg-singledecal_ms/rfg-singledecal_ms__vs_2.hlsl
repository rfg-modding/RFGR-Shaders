...
{
    float4 _62 = r0;
    _62.x = shader_in[7].x * asfloat(1082130432u);
    r0 = _62;
    float3 _75 = (r0.xxx * shader_in[6].xyz) + shader_in[0].xyz;
    ...
    float3 _295 = (shader_in[4].xyz * asfloat(uint3(1073741824u, 1073741824u, 1073741824u))) + asfloat(uint3(3212836864u, 3212836864u, 3212836864u));
    r1 = float4(_295.x, _295.y, _295.z, r1.w);
    float3 _305 = (shader_in[8].xyz * asfloat(uint3(1073741824u, 1073741824u, 1073741824u))) + asfloat(uint3(3212836864u, 3212836864u, 3212836864u));
    r2 = float4(_305.x, _305.y, _305.z, r2.w);
    float3 _317 = (shader_in[7].xxx * r2.xyz) + r1.xyz;
    ...
    float2 _687 = r0.xy * float2(cb2_m[2].y, cb2_m[2].z);
