...
void vs_main()
{
    ...
    o4 = float4(_427.x, _427.y, _427.z, o4.w);
    float4 _431 = o4;
    _431.w = asfloat(0u);
    o4 = _431;
    float4 _440 = r0;
    _440.w = r0.y * cb0_m[13].x;
    r0 = _440;
    float4 _447 = r1;
    _447.x = r0.w * asfloat(3216550459u);
    r1 = _447;
    float4 _452 = r1;
    _452.x = exp2(r1.x);
    r1 = _452;
    float4 _459 = r1;
    _459.x = (-r1.x) + asfloat(1065353216u);
    r1 = _459;
    float4 _466 = r0;
    _466.w = r1.x / r0.w;
    r0 = _466;
    float4 _478 = r1;
    _478.x = asfloat((asfloat(1008981770u) < abs(r0.y)) ? 4294967295u : 0u);
    r1 = _478;
    float4 _493 = r0;
    _493.x = mad(r0.xyz.z, r0.xyz.z, mad(r0.xyz.y, r0.xyz.y, r0.xyz.x * r0.xyz.x));
    r0 = _493;
    float4 _498 = r0;
    _498.x = sqrt(r0.x);
    r0 = _498;
    float4 _506 = r0;
    _506.x = r0.x * cb0_m[13].y;
    r0 = _506;
    float4 _516 = r0;
    _516.y = (asuint(r1.x) != 0u) ? r0.w : asfloat(1065353216u);
    r0 = _516;
    float4 _528 = r0;
    _528.x = (r0.y * r0.x) + (-cb0_m[13].w);
    r0 = _528;
    float4 _534 = r0;
    _534.x = exp2(-r0.x);
    r0 = _534;
    float4 _540 = r0;
    _540.x = min(r0.x, asfloat(1065353216u));
    r0 = _540;
    float4 _547 = o5;
    _547.w = (-r0.x) + asfloat(1065353216u);
    o5 = _547;
    float3 _556 = float3(cb1_m[1].x, cb1_m[1].y, cb1_m[1].z);
    o5 = float4(_556.x, _556.y, _556.z, o5.w);
}

void vert_main()
{
    shader_in[0] = float4(v0.x, v0.y, v0.z, shader_in[0].w);
    float2 _565 = asfloat(v1);
    shader_in[1] = float4(_565.x, _565.y, shader_in[1].z, shader_in[1].w);
