...
void vs_main()
{
    ...
    float3 _1055 = o2;
    _1055.z = mad(_1043.z, r1.xyz.z, mad(_1043.y, r1.xyz.y, _1043.x * r1.xyz.x));
    o2 = _1055;
    float4 _1059 = o3;
    _1059.z = r1.y;
    o3 = _1059;
    ...
    o3 = _1084;
    float4 _1093 = r0;
    _1093.x = r0.z * cb0_m[13].x;
    r0 = _1093;
    float4 _1100 = r1;
    _1100.x = r0.x * asfloat(3216550459u);
    r1 = _1100;
    float4 _1105 = r1;
    _1105.x = exp2(r1.x);
    r1 = _1105;
    float4 _1112 = r1;
    _1112.x = (-r1.x) + asfloat(1065353216u);
    r1 = _1112;
    float4 _1119 = r0;
    _1119.x = r1.x / r0.x;
    r0 = _1119;
    float4 _1131 = r1;
    _1131.x = asfloat((asfloat(1008981770u) < abs(r0.z)) ? 4294967295u : 0u);
    r1 = _1131;
    float4 _1146 = r0;
    _1146.y = mad(r0.yzw.z, r0.yzw.z, mad(r0.yzw.y, r0.yzw.y, r0.yzw.x * r0.yzw.x));
    r0 = _1146;
    float4 _1151 = r0;
    _1151.y = sqrt(r0.y);
    r0 = _1151;
    float4 _1159 = r0;
    _1159.y = r0.y * cb0_m[13].y;
    r0 = _1159;
    float4 _1169 = r0;
    _1169.x = (asuint(r1.x) != 0u) ? r0.x : asfloat(1065353216u);
    r0 = _1169;
    float4 _1181 = r0;
    _1181.x = (r0.x * r0.y) + (-cb0_m[13].w);
    r0 = _1181;
    float4 _1187 = r0;
    _1187.x = exp2(-r0.x);
    r0 = _1187;
    float4 _1193 = r0;
    _1193.x = min(r0.x, asfloat(1065353216u));
    r0 = _1193;
    float4 _1200 = o3;
    _1200.w = (-r0.x) + asfloat(1065353216u);
    o3 = _1200;
    float2 _1206 = float2(asint(shader_in[2].xy));
    r0 = float4(_1206.x, _1206.y, r0.z, r0.w);
    float2 _1217 = r0.xy * float2(cb2_m[1].y, cb2_m[1].z);
    r0 = float4(_1217.x, _1217.y, r0.z, r0.w);
    float2 _1223 = r0.xy * asfloat(uint2(981467136u, 981467136u));
    o4 = float4(o4.x, o4.y, _1223.x, _1223.y);
    float2 _1230 = float2(asint(shader_in[1].xy));
    r0 = float4(_1230.x, _1230.y, r0.z, r0.w);
    float2 _1236 = r0.xy * asfloat(uint2(981467136u, 981467136u));
    o4 = float4(_1236.x, _1236.y, o4.z, o4.w);
}

void vert_main()
{
    shader_in[0] = float4(v0.x, v0.y, v0.z, shader_in[0].w);
    float2 _1245 = asfloat(v1);
    shader_in[1] = float4(_1245.x, _1245.y, shader_in[1].z, shader_in[1].w);
    float2 _1250 = asfloat(v2);
    shader_in[2] = float4(_1250.x, _1250.y, shader_in[2].z, shader_in[2].w);
    float2 _1255 = asfloat(v3);
    shader_in[3] = float4(_1255.x, _1255.y, shader_in[3].z, shader_in[3].w);
