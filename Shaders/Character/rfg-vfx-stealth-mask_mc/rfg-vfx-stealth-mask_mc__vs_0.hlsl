...
void vs_main()
{
    ...
    r1 = _433;
    float4 _444 = float4(cb6_m[2].x, cb6_m[2].y, cb6_m[2].z, cb6_m[2].w);
    float4 _458 = r1;
    _458.z = mad(_444.w, r0.w, mad(_444.z, r0.z, mad(_444.y, r0.y, _444.x * r0.x)));
    r1 = _458;
    float4 _469 = float4(cb6_m[1].x, cb6_m[1].y, cb6_m[1].z, cb6_m[1].w);
    float4 _483 = r1;
    _483.y = mad(_469.w, r0.w, mad(_469.z, r0.z, mad(_469.y, r0.y, _469.x * r0.x)));
    r1 = _483;
    float4 _486 = r1;
    ...
    float4 _617 = r0;
    _617.w = asfloat((cb6_m[3].w < r1.y) ? 4294967295u : 0u);
    r0 = _617;
    float4 _624 = o1;
    _624.w = asfloat(asuint(r0.w) & 1065353216u);
    o1 = _624;
    float4 _633 = r0;
    _633.w = r0.y * cb0_m[13].x;
    r0 = _633;
    float4 _640 = r1;
    _640.x = r0.w * asfloat(3216550459u);
    r1 = _640;
    float4 _645 = r1;
    _645.x = exp2(r1.x);
    r1 = _645;
    float4 _652 = r1;
    _652.x = (-r1.x) + asfloat(1065353216u);
    r1 = _652;
    float4 _659 = r0;
    _659.w = r1.x / r0.w;
    r0 = _659;
    ...
    r0 = _731;
    float3 _738 = o2;
    _738.z = (-r0.x) + asfloat(1065353216u);
    o2 = _738;
    float2 _745 = float2(asint(shader_in[1].xy));
    r0 = float4(_745.x, _745.y, r0.z, r0.w);
    float2 _754 = r0.xy * asfloat(uint2(989855744u, 989855744u));
    o2 = float3(_754.x, _754.y, o2.z);
}

void vert_main()
{
    shader_in[0] = float4(v0.x, v0.y, v0.z, shader_in[0].w);
    float2 _763 = asfloat(v1);
    shader_in[1] = float4(_763.x, _763.y, shader_in[1].z, shader_in[1].w);
    shader_in[3] = v3;
    shader_in[5] = v5;
