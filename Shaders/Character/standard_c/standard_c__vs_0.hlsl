...
void vs_main()
{
    ...
    o0 = _584;
    float3 _598 = r4.xyz + (-float3(cb0_m[11].x, cb0_m[11].y, cb0_m[11].z));
    r0 = float4(r0.x, _598.x, _598.y, _598.z);
    float2 _605 = float2(asint(shader_in[1].xy));
    r1 = float4(_605.x, _605.y, r1.z, r1.w);
    o1 = r1.xy * asfloat(uint2(981467136u, 981467136u));
    o2 = float3(cb1_m[0].x, cb1_m[0].y, cb1_m[0].z);
    float3 _634 = (shader_in[2].xyz * asfloat(uint3(1073741824u, 1073741824u, 1073741824u))) + asfloat(uint3(3212836864u, 3212836864u, 3212836864u));
    r1 = float4(_634.x, _634.y, _634.z, r1.w);
    float4 _650 = r3;
    _650.x = mad(r3.xyz.z, r1.xyz.z, mad(r3.xyz.y, r1.xyz.y, r3.xyz.x * r1.xyz.x));
    r3 = _650;
    float4 _665 = r3;
    _665.y = mad(r5.xyz.z, r1.xyz.z, mad(r5.xyz.y, r1.xyz.y, r5.xyz.x * r1.xyz.x));
    r3 = _665;
    float4 _680 = r3;
    _680.z = mad(r2.xyz.z, r1.xyz.z, mad(r2.xyz.y, r1.xyz.y, r2.xyz.x * r1.xyz.x));
    r3 = _680;
    float3 _686 = r0.xxx * r3.xyz;
    r1 = float4(_686.x, _686.y, _686.z, r1.w);
    float4 _702 = r0;
    _702.x = mad(r1.xyz.z, r1.xyz.z, mad(r1.xyz.y, r1.xyz.y, r1.xyz.x * r1.xyz.x));
    r0 = _702;
    float4 _707 = r0;
    _707.x = rsqrt(r0.x);
    r0 = _707;
    ...
    float3 _723 = float3(cb6_m[0].x, cb6_m[0].y, cb6_m[0].z);
    float4 _735 = r2;
    _735.x = mad(_723.z, r1.xyz.z, mad(_723.y, r1.xyz.y, _723.x * r1.xyz.x));
    r2 = _735;
    float3 _744 = float3(cb6_m[1].x, cb6_m[1].y, cb6_m[1].z);
    float4 _756 = r2;
    _756.y = mad(_744.z, r1.xyz.z, mad(_744.y, r1.xyz.y, _744.x * r1.xyz.x));
    r2 = _756;
    float3 _765 = float3(cb6_m[2].x, cb6_m[2].y, cb6_m[2].z);
    float4 _777 = r2;
    _777.z = mad(_765.z, r1.xyz.z, mad(_765.y, r1.xyz.y, _765.x * r1.xyz.x));
    r2 = _777;
    float4 _792 = r0;
    _792.x = mad(r2.xyz.z, r2.xyz.z, mad(r2.xyz.y, r2.xyz.y, r2.xyz.x * r2.xyz.x));
    r0 = _792;
    float4 _797 = r0;
    _797.x = rsqrt(r0.x);
    r0 = _797;
    float3 _803 = r0.xxx * r2.xyz;
    o3 = float4(_803.x, _803.y, _803.z, o3.w);
    float4 _813 = r0;
    _813.x = r0.z * cb0_m[13].x;
    r0 = _813;
    float4 _820 = r1;
    _820.x = r0.x * asfloat(3216550459u);
    r1 = _820;
    float4 _825 = r1;
    _825.x = exp2(r1.x);
    r1 = _825;
    float4 _832 = r1;
    _832.x = (-r1.x) + asfloat(1065353216u);
    r1 = _832;
    float4 _839 = r0;
    _839.x = r1.x / r0.x;
    r0 = _839;
    float4 _851 = r1;
    _851.x = asfloat((asfloat(1008981770u) < abs(r0.z)) ? 4294967295u : 0u);
    r1 = _851;
    float4 _866 = r0;
    _866.y = mad(r0.yzw.z, r0.yzw.z, mad(r0.yzw.y, r0.yzw.y, r0.yzw.x * r0.yzw.x));
    r0 = _866;
    float4 _871 = r0;
    _871.y = sqrt(r0.y);
    r0 = _871;
    float4 _879 = r0;
    _879.y = r0.y * cb0_m[13].y;
    r0 = _879;
    float4 _889 = r0;
    _889.x = (asuint(r1.x) != 0u) ? r0.x : asfloat(1065353216u);
    r0 = _889;
    float4 _901 = r0;
    _901.x = (r0.x * r0.y) + (-cb0_m[13].w);
    r0 = _901;
    float4 _907 = r0;
    _907.x = exp2(-r0.x);
    r0 = _907;
    float4 _913 = r0;
    _913.x = min(r0.x, asfloat(1065353216u));
    r0 = _913;
    float4 _920 = o3;
    _920.w = (-r0.x) + asfloat(1065353216u);
    o3 = _920;
}
...
void vert_main()
{
    ...
    float2 _928 = asfloat(v1);
    shader_in[1] = float4(_928.x, _928.y, shader_in[1].z, shader_in[1].w);
