...
void vs_main()
{
    ...
    r3 = float4(_1000.x, _1000.y, _1000.z, r3.w);
    float3 _1016 = o2;
    _1016.y = mad(r3.xyz.z, r2.xyz.z, mad(r3.xyz.y, r2.xyz.y, r3.xyz.x * r2.xyz.x));
    o2 = _1016;
    float3 _1031 = o2;
    _1031.z = mad(r3.xyz.z, r0.yzw.z, mad(r3.xyz.y, r0.yzw.y, r3.xyz.x * r0.yzw.x));
    o2 = _1031;
    float3 _1046 = o2;
    _1046.x = mad(r3.xyz.z, r1.xyz.z, mad(r3.xyz.y, r1.xyz.y, r3.xyz.x * r1.xyz.x));
    o2 = _1046;
    float3 _1059 = (-r4.xyz) + float3(cb1_m[0].x, cb1_m[0].y, cb1_m[0].z);
    r3 = float4(_1059.x, _1059.y, _1059.z, r3.w);
    float3 _1073 = r4.xyz + (-float3(cb0_m[11].x, cb0_m[11].y, cb0_m[11].z));
    r4 = float4(_1073.x, _1073.y, _1073.z, r4.w);
    float4 _1086 = r0;
    _1086.x = mad(r3.xz.y, r3.xz.y, r3.xz.x * r3.xz.x);
    r0 = _1086;
    float4 _1091 = r0;
    _1091.x = sqrt(r0.x);
    r0 = _1091;
    float4 _1101 = r0;
    _1101.x = asfloat((asfloat(0u) < r0.x) ? 4294967295u : 0u);
    r0 = _1101;
    float4 _1108 = r0;
    _1108.x = asfloat(asuint(r0.x) & 1065353216u);
    r0 = _1108;
    float4 _1111 = r3;
    _1111.w = asfloat(0u);
    r3 = _1111;
    float3 _1118 = (-r3.xyz) + r3.xwz;
    r5 = float4(_1118.x, _1118.y, _1118.z, r5.w);
    float3 _1128 = (r0.xxx * r5.xyz) + r3.xyz;
    r3 = float4(_1128.x, _1128.y, _1128.z, r3.w);
    float4 _1144 = r0;
    _1144.x = mad(r3.xyz.z, r3.xyz.z, mad(r3.xyz.y, r3.xyz.y, r3.xyz.x * r3.xyz.x));
    r0 = _1144;
    float4 _1149 = r0;
    _1149.x = rsqrt(r0.x);
    r0 = _1149;
    float3 _1155 = r0.xxx * r3.xyz;
    r3 = float4(_1155.x, _1155.y, _1155.z, r3.w);
    float3 _1171 = o3;
    _1171.x = mad(r3.xyz.z, r1.xyz.z, mad(r3.xyz.y, r1.xyz.y, r3.xyz.x * r1.xyz.x));
    o3 = _1171;
    float3 _1186 = o3;
    _1186.z = mad(r3.xyz.z, r0.yzw.z, mad(r3.xyz.y, r0.yzw.y, r3.xyz.x * r0.yzw.x));
    o3 = _1186;
    float3 _1201 = o3;
    _1201.y = mad(r3.xyz.z, r2.xyz.z, mad(r3.xyz.y, r2.xyz.y, r3.xyz.x * r2.xyz.x));
    o3 = _1201;
    float4 _1210 = r0;
    _1210.x = r4.y * cb0_m[13].x;
    r0 = _1210;
    float4 _1217 = r0;
    _1217.y = r0.x * asfloat(3216550459u);
    r0 = _1217;
    float4 _1222 = r0;
    _1222.y = exp2(r0.y);
    r0 = _1222;
    float4 _1229 = r0;
    _1229.y = (-r0.y) + asfloat(1065353216u);
    r0 = _1229;
    float4 _1236 = r0;
    _1236.x = r0.y / r0.x;
    r0 = _1236;
    float4 _1246 = r0;
    _1246.y = asfloat((asfloat(1008981770u) < abs(r4.y)) ? 4294967295u : 0u);
    r0 = _1246;
    float4 _1261 = r0;
    _1261.z = mad(r4.xyz.z, r4.xyz.z, mad(r4.xyz.y, r4.xyz.y, r4.xyz.x * r4.xyz.x));
    r0 = _1261;
    float4 _1266 = r0;
    _1266.z = sqrt(r0.z);
    r0 = _1266;
    float4 _1274 = r0;
    _1274.z = r0.z * cb0_m[13].y;
    r0 = _1274;
    float4 _1284 = r0;
    _1284.x = (asuint(r0.y) != 0u) ? r0.x : asfloat(1065353216u);
    r0 = _1284;
    float4 _1296 = r0;
    _1296.x = (r0.x * r0.z) + (-cb0_m[13].w);
    r0 = _1296;
    float4 _1302 = r0;
    _1302.x = exp2(-r0.x);
    r0 = _1302;
    float4 _1308 = r0;
    _1308.x = min(r0.x, asfloat(1065353216u));
    r0 = _1308;
    float4 _1315 = o4;
    _1315.w = (-r0.x) + asfloat(1065353216u);
    o4 = _1315;
    float3 _1324 = float3(cb1_m[1].x, cb1_m[1].y, cb1_m[1].z);
    o4 = float4(_1324.x, _1324.y, _1324.z, o4.w);
}
