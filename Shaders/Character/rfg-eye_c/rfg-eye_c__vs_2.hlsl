...
void vs_main()
{
    ...
    float3 _1015 = o2;
    _1015.y = mad(r0.yzw.z, r3.xyz.z, mad(r0.yzw.y, r3.xyz.y, r0.yzw.x * r3.xyz.x));
    o2 = _1015;
    float3 _1030 = o2;
    _1030.z = mad(r0.yzw.z, r1.xyz.z, mad(r0.yzw.y, r1.xyz.y, r0.yzw.x * r1.xyz.x));
    o2 = _1030;
    float3 _1045 = o2;
    _1045.x = mad(r0.yzw.z, r2.xyz.z, mad(r0.yzw.y, r2.xyz.y, r0.yzw.x * r2.xyz.x));
    o2 = _1045;
    float2 _1052 = float2(cb1_m[0].x, cb1_m[0].z);
    float2 _1058 = float2(cb1_m[0].x, cb1_m[0].z);
    float4 _1065 = r0;
    _1065.x = mad(_1052.y, _1058.y, _1052.x * _1058.x);
    r0 = _1065;
    float4 _1070 = r0;
    _1070.x = sqrt(r0.x);
    r0 = _1070;
    float4 _1080 = r0;
    _1080.x = asfloat((asfloat(0u) < r0.x) ? 4294967295u : 0u);
    r0 = _1080;
    float4 _1087 = r0;
    _1087.x = asfloat(asuint(r0.x) & 1065353216u);
    r0 = _1087;
    float2 _1094 = float2(cb1_m[0].x, cb1_m[0].z);
    r4 = float4(_1094.x, r4.y, _1094.y, r4.w);
    float4 _1098 = r4;
    _1098.y = asfloat(0u);
    r4 = _1098;
    float3 _1111 = r4.xyz + (-float3(cb1_m[0].x, cb1_m[0].y, cb1_m[0].z));
    r0 = float4(r0.x, _1111.x, _1111.y, _1111.z);
    float3 _1127 = (r0.xxx * r0.yzw) + float3(cb1_m[0].x, cb1_m[0].y, cb1_m[0].z);
    r0 = float4(_1127.x, _1127.y, _1127.z, r0.w);
    float4 _1143 = r0;
    _1143.w = mad(r0.xyz.z, r0.xyz.z, mad(r0.xyz.y, r0.xyz.y, r0.xyz.x * r0.xyz.x));
    r0 = _1143;
    float4 _1148 = r0;
    _1148.w = rsqrt(r0.w);
    r0 = _1148;
    float3 _1154 = r0.www * r0.xyz;
    r0 = float4(_1154.x, _1154.y, _1154.z, r0.w);
    float3 _1170 = o3;
    _1170.x = mad(r0.xyz.z, r2.xyz.z, mad(r0.xyz.y, r2.xyz.y, r0.xyz.x * r2.xyz.x));
    o3 = _1170;
    float3 _1185 = o3;
    _1185.z = mad(r0.xyz.z, r1.xyz.z, mad(r0.xyz.y, r1.xyz.y, r0.xyz.x * r1.xyz.x));
    o3 = _1185;
    float3 _1200 = o3;
    _1200.y = mad(r0.xyz.z, r3.xyz.z, mad(r0.xyz.y, r3.xyz.y, r0.xyz.x * r3.xyz.x));
    o3 = _1200;
}
...
void vert_main()
{
    ...
    float2 _1208 = asfloat(v1);
    shader_in[1] = float4(_1208.x, _1208.y, shader_in[1].z, shader_in[1].w);
