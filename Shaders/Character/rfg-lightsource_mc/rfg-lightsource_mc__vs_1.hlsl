...
void vs_main()
{
    ...
    _899.x = rsqrt(r0.x);
    r0 = _899;
    float3 _905 = r0.xxx * r2.xyz;
    o4 = float4(_905.x, _905.y, _905.z, o4.w);
    float4 _909 = o4;
    _909.w = asfloat(0u);
    o4 = _909;
    float4 _918 = r0;
    _918.x = r1.y * cb0_m[13].x;
    r0 = _918;
    float4 _925 = r0;
    _925.y = r0.x * asfloat(3216550459u);
    r0 = _925;
    float4 _930 = r0;
    _930.y = exp2(r0.y);
    r0 = _930;
    float4 _937 = r0;
    _937.y = (-r0.y) + asfloat(1065353216u);
    r0 = _937;
    float4 _944 = r0;
    _944.x = r0.y / r0.x;
    r0 = _944;
    float4 _956 = r0;
    _956.y = asfloat((asfloat(1008981770u) < abs(r1.y)) ? 4294967295u : 0u);
    r0 = _956;
    float4 _971 = r0;
    _971.z = mad(r1.xyz.z, r1.xyz.z, mad(r1.xyz.y, r1.xyz.y, r1.xyz.x * r1.xyz.x));
    r0 = _971;
    float4 _976 = r0;
    _976.z = sqrt(r0.z);
    r0 = _976;
    float4 _984 = r0;
    _984.z = r0.z * cb0_m[13].y;
    r0 = _984;
    float4 _994 = r0;
    _994.x = (asuint(r0.y) != 0u) ? r0.x : asfloat(1065353216u);
    r0 = _994;
    float4 _1006 = r0;
    _1006.x = (r0.x * r0.z) + (-cb0_m[13].w);
    r0 = _1006;
    float4 _1012 = r0;
    _1012.x = exp2(-r0.x);
    r0 = _1012;
    float4 _1018 = r0;
    _1018.x = min(r0.x, asfloat(1065353216u));
    r0 = _1018;
    float4 _1025 = o5;
    _1025.w = (-r0.x) + asfloat(1065353216u);
    o5 = _1025;
    float3 _1034 = float3(cb1_m[1].x, cb1_m[1].y, cb1_m[1].z);
    o5 = float4(_1034.x, _1034.y, _1034.z, o5.w);
}

void vert_main()
{
    shader_in[0] = float4(v0.x, v0.y, v0.z, shader_in[0].w);
    float2 _1043 = asfloat(v1);
    shader_in[1] = float4(_1043.x, _1043.y, shader_in[1].z, shader_in[1].w);
