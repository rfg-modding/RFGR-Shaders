...
void vs_main()
{
    ...
    o0 = _577;
    float3 _597 = (-float3(cb0_m[14].x, cb0_m[14].y, cb0_m[14].z)) + float3(cb6_m[3].x, cb6_m[3].y, cb6_m[3].z);
    r0 = float4(_597.x, _597.y, _597.z, r0.w);
    float3 _605 = (-r0.xyz) + r1.xyz;
    ...
    r0 = _626;
    float4 _633 = o1;
    _633.w = r0.x * asfloat(1056964608u);
    o1 = _633;
    float2 _640 = float2(asint(shader_in[1].xy));
    r0 = float4(_640.x, _640.y, r0.z, r0.w);
    float2 _651 = r0.xy * float2(cb2_m[0].x, cb2_m[0].y);
    r0 = float4(_651.x, _651.y, r0.z, r0.w);
    float2 _660 = r0.xy * asfloat(uint2(981467136u, 981467136u));
    o1 = float4(_660.x, _660.y, o1.z, o1.w);
    float4 _666 = o1;
    _666.z = cb6_m[3].w;
    o1 = _666;
}
...
void vert_main()
{
    ...
    float2 _674 = asfloat(v1);
    shader_in[1] = float4(_674.x, _674.y, shader_in[1].z, shader_in[1].w);
    shader_in[3] = v3;
