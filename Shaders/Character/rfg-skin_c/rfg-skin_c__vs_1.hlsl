...
void vs_main()
{
    ...
    float3 _999 = (-r4.xyz) + float3(cb1_m[0].x, cb1_m[0].y, cb1_m[0].z);
    r3 = float4(_999.x, _999.y, _999.z, r3.w);
    float3 _1015 = o2;
    _1015.y = mad(r3.xyz.z, r2.xyz.z, mad(r3.xyz.y, r2.xyz.y, r3.xyz.x * r2.xyz.x));
    o2 = _1015;
    float3 _1030 = o2;
    _1030.z = mad(r3.xyz.z, r0.yzw.z, mad(r3.xyz.y, r0.yzw.y, r3.xyz.x * r0.yzw.x));
    o2 = _1030;
    float3 _1045 = o2;
    _1045.x = mad(r3.xyz.z, r1.xyz.z, mad(r3.xyz.y, r1.xyz.y, r3.xyz.x * r1.xyz.x));
    o2 = _1045;
    float3 _1059 = (-r4.xyz) + float3(cb0_m[11].x, cb0_m[11].y, cb0_m[11].z);
    ...
    float4 _1089 = r0;
    _1089.x = mad(r3.xyz.z, r3.xyz.z, mad(r3.xyz.y, r3.xyz.y, r3.xyz.x * r3.xyz.x));
    r0 = _1089;
    float4 _1094 = r0;
    _1094.x = rsqrt(r0.x);
    r0 = _1094;
    float3 _1100 = r0.xxx * r3.xyz;
    r3 = float4(_1100.x, _1100.y, _1100.z, r3.w);
    float3 _1116 = o3;
    _1116.x = mad(r3.xyz.z, r1.xyz.z, mad(r3.xyz.y, r1.xyz.y, r3.xyz.x * r1.xyz.x));
    o3 = _1116;
    float3 _1125 = float3(cb1_m[1].x, cb1_m[1].y, cb1_m[1].z);
    float4 _1137 = o4;
    _1137.x = mad(_1125.z, r1.xyz.z, mad(_1125.y, r1.xyz.y, _1125.x * r1.xyz.x));
    o4 = _1137;
    float3 _1152 = o3;
    _1152.z = mad(r3.xyz.z, r0.yzw.z, mad(r3.xyz.y, r0.yzw.y, r3.xyz.x * r0.yzw.x));
    o3 = _1152;
    float3 _1161 = float3(cb1_m[1].x, cb1_m[1].y, cb1_m[1].z);
    float4 _1173 = o4;
    _1173.z = mad(_1161.z, r0.yzw.z, mad(_1161.y, r0.yzw.y, _1161.x * r0.yzw.x));
    o4 = _1173;
    float3 _1188 = o3;
    ...
    float4 _1209 = o4;
    _1209.y = mad(_1197.z, r2.xyz.z, mad(_1197.y, r2.xyz.y, _1197.x * r2.xyz.x));
    o4 = _1209;
    float4 _1218 = r0;
    _1218.x = r4.y * cb0_m[13].x;
    r0 = _1218;
    float4 _1225 = r0;
    _1225.y = r0.x * asfloat(3216550459u);
    r0 = _1225;
    float4 _1230 = r0;
    _1230.y = exp2(r0.y);
    r0 = _1230;
    float4 _1237 = r0;
    _1237.y = (-r0.y) + asfloat(1065353216u);
    r0 = _1237;
    float4 _1244 = r0;
    _1244.x = r0.y / r0.x;
    r0 = _1244;
    float4 _1256 = r0;
    _1256.y = asfloat((asfloat(1008981770u) < abs(r4.y)) ? 4294967295u : 0u);
    r0 = _1256;
    float4 _1271 = r0;
    _1271.z = mad(r4.xyz.z, r4.xyz.z, mad(r4.xyz.y, r4.xyz.y, r4.xyz.x * r4.xyz.x));
    r0 = _1271;
    float4 _1276 = r0;
    _1276.z = sqrt(r0.z);
    r0 = _1276;
    float4 _1284 = r0;
    _1284.z = r0.z * cb0_m[13].y;
    r0 = _1284;
    float4 _1294 = r0;
    _1294.x = (asuint(r0.y) != 0u) ? r0.x : asfloat(1065353216u);
    r0 = _1294;
    float4 _1306 = r0;
    _1306.x = (r0.x * r0.z) + (-cb0_m[13].w);
    r0 = _1306;
    float4 _1312 = r0;
    _1312.x = exp2(-r0.x);
    r0 = _1312;
    float4 _1318 = r0;
    _1318.x = min(r0.x, asfloat(1065353216u));
    r0 = _1318;
    float4 _1325 = o4;
    _1325.w = (-r0.x) + asfloat(1065353216u);
    o4 = _1325;
}
