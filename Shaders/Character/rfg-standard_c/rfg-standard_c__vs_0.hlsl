...
void vs_main()
{
    ...
    float3 _1113 = o3;
    _1113.x = mad(r3.xyz.z, r1.xyz.z, mad(r3.xyz.y, r1.xyz.y, r3.xyz.x * r1.xyz.x));
    o3 = _1113;
    float4 _1117 = o4;
    _1117.x = r1.y;
    o4 = _1117;
    ...
    o4 = _1136;
    float3 _1151 = o3;
    _1151.y = mad(r3.xyz.z, r2.xyz.z, mad(r3.xyz.y, r2.xyz.y, r3.xyz.x * r2.xyz.x));
    o3 = _1151;
    float4 _1155 = o4;
    _1155.y = r2.y;
    o4 = _1155;
    float4 _1164 = r0;
    _1164.x = r4.y * cb0_m[13].x;
    r0 = _1164;
    float4 _1171 = r0;
    _1171.y = r0.x * asfloat(3216550459u);
    r0 = _1171;
    float4 _1176 = r0;
    _1176.y = exp2(r0.y);
    r0 = _1176;
    float4 _1183 = r0;
    _1183.y = (-r0.y) + asfloat(1065353216u);
    r0 = _1183;
    float4 _1190 = r0;
    _1190.x = r0.y / r0.x;
    r0 = _1190;
    float4 _1202 = r0;
    _1202.y = asfloat((asfloat(1008981770u) < abs(r4.y)) ? 4294967295u : 0u);
    r0 = _1202;
    float4 _1217 = r0;
    _1217.z = mad(r4.xyz.z, r4.xyz.z, mad(r4.xyz.y, r4.xyz.y, r4.xyz.x * r4.xyz.x));
    r0 = _1217;
    float4 _1222 = r0;
    _1222.z = sqrt(r0.z);
    r0 = _1222;
    float4 _1230 = r0;
    _1230.z = r0.z * cb0_m[13].y;
    r0 = _1230;
    float4 _1240 = r0;
    _1240.x = (asuint(r0.y) != 0u) ? r0.x : asfloat(1065353216u);
    r0 = _1240;
    float4 _1252 = r0;
    _1252.x = (r0.x * r0.z) + (-cb0_m[13].w);
    r0 = _1252;
    float4 _1258 = r0;
    _1258.x = exp2(-r0.x);
    r0 = _1258;
    float4 _1264 = r0;
    _1264.x = min(r0.x, asfloat(1065353216u));
    r0 = _1264;
    float4 _1271 = o4;
    _1271.w = (-r0.x) + asfloat(1065353216u);
    o4 = _1271;
    ...
    o5 = float4(_1283.x, _1283.y, o5.z, o5.w);
    float2 _1290 = float2(asint(shader_in[3].xy));
    r0 = float4(_1290.x, _1290.y, r0.z, r0.w);
    float2 _1296 = r0.xy * asfloat(uint2(981467136u, 981467136u));
    o5 = float4(o5.x, o5.y, _1296.x, _1296.y);
}

void vert_main()
{
    shader_in[0] = float4(v0.x, v0.y, v0.z, shader_in[0].w);
    float2 _1305 = asfloat(v1);
    shader_in[1] = float4(_1305.x, _1305.y, shader_in[1].z, shader_in[1].w);
    float2 _1310 = asfloat(v2);
    shader_in[2] = float4(_1310.x, _1310.y, shader_in[2].z, shader_in[2].w);
    float2 _1315 = asfloat(v3);
    shader_in[3] = float4(_1315.x, _1315.y, shader_in[3].z, shader_in[3].w);
