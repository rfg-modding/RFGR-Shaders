...
void vs_main()
{
    ...
    float2 _611 = r0.yz * float2(cb2_m[2].y, cb2_m[2].z);
    ...
    float3 _1109 = o3;
    _1109.x = mad(r3.xyz.z, r1.xyz.z, mad(r3.xyz.y, r1.xyz.y, r3.xyz.x * r1.xyz.x));
    o3 = _1109;
    float3 _1118 = float3(cb1_m[1].x, cb1_m[1].y, cb1_m[1].z);
    float4 _1130 = o4;
    _1130.x = mad(_1118.z, r1.xyz.z, mad(_1118.y, r1.xyz.y, _1118.x * r1.xyz.x));
    o4 = _1130;
    float3 _1145 = o3;
    _1145.z = mad(r3.xyz.z, r0.yzw.z, mad(r3.xyz.y, r0.yzw.y, r3.xyz.x * r0.yzw.x));
    o3 = _1145;
    float3 _1154 = float3(cb1_m[1].x, cb1_m[1].y, cb1_m[1].z);
    float4 _1166 = o4;
    _1166.z = mad(_1154.z, r0.yzw.z, mad(_1154.y, r0.yzw.y, _1154.x * r0.yzw.x));
    o4 = _1166;
    float3 _1181 = o3;
    _1181.y = mad(r3.xyz.z, r2.xyz.z, mad(r3.xyz.y, r2.xyz.y, r3.xyz.x * r2.xyz.x));
    o3 = _1181;
    float3 _1190 = float3(cb1_m[1].x, cb1_m[1].y, cb1_m[1].z);
    float4 _1202 = o4;
    _1202.y = mad(_1190.z, r2.xyz.z, mad(_1190.y, r2.xyz.y, _1190.x * r2.xyz.x));
    o4 = _1202;
    float4 _1211 = r0;
    _1211.x = r4.y * cb0_m[13].x;
    r0 = _1211;
    float4 _1218 = r0;
    _1218.y = r0.x * asfloat(3216550459u);
    r0 = _1218;
    float4 _1223 = r0;
    _1223.y = exp2(r0.y);
    r0 = _1223;
    float4 _1230 = r0;
    _1230.y = (-r0.y) + asfloat(1065353216u);
    r0 = _1230;
    float4 _1237 = r0;
    _1237.x = r0.y / r0.x;
    r0 = _1237;
    float4 _1249 = r0;
    _1249.y = asfloat((asfloat(1008981770u) < abs(r4.y)) ? 4294967295u : 0u);
    r0 = _1249;
    float4 _1264 = r0;
    _1264.z = mad(r4.xyz.z, r4.xyz.z, mad(r4.xyz.y, r4.xyz.y, r4.xyz.x * r4.xyz.x));
    r0 = _1264;
    float4 _1269 = r0;
    _1269.z = sqrt(r0.z);
    r0 = _1269;
    float4 _1277 = r0;
    _1277.z = r0.z * cb0_m[13].y;
    r0 = _1277;
    float4 _1287 = r0;
    _1287.x = (asuint(r0.y) != 0u) ? r0.x : asfloat(1065353216u);
    r0 = _1287;
    float4 _1299 = r0;
    _1299.x = (r0.x * r0.z) + (-cb0_m[13].w);
    r0 = _1299;
    float4 _1305 = r0;
    _1305.x = exp2(-r0.x);
    r0 = _1305;
    float4 _1311 = r0;
    _1311.x = min(r0.x, asfloat(1065353216u));
    r0 = _1311;
    float4 _1318 = o4;
    _1318.w = (-r0.x) + asfloat(1065353216u);
    o4 = _1318;
    float2 _1324 = float2(asint(shader_in[1].xy));
    r0 = float4(_1324.x, _1324.y, r0.z, r0.w);
    float2 _1330 = r0.xy * asfloat(uint2(981467136u, 981467136u));
    o5 = float4(_1330.x, _1330.y, o5.z, o5.w);
    float2 _1337 = float2(asint(shader_in[3].xy));
    r0 = float4(_1337.x, _1337.y, r0.z, r0.w);
    float2 _1343 = r0.xy * asfloat(uint2(981467136u, 981467136u));
    o5 = float4(o5.x, o5.y, _1343.x, _1343.y);
}

void vert_main()
{
    shader_in[0] = float4(v0.x, v0.y, v0.z, shader_in[0].w);
    float2 _1352 = asfloat(v1);
    shader_in[1] = float4(_1352.x, _1352.y, shader_in[1].z, shader_in[1].w);
    float2 _1357 = asfloat(v2);
    shader_in[2] = float4(_1357.x, _1357.y, shader_in[2].z, shader_in[2].w);
    float2 _1362 = asfloat(v3);
    shader_in[3] = float4(_1362.x, _1362.y, shader_in[3].z, shader_in[3].w);
