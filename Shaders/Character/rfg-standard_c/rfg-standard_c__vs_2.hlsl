...
void vs_main()
{
    ...
    o2 = _1030;
    float3 _1045 = o3;
    _1045.y = mad(r0.yzw.z, r3.xyz.z, mad(r0.yzw.y, r3.xyz.y, r0.yzw.x * r3.xyz.x));
    o3 = _1045;
    float3 _1054 = float3(cb1_m[0].x, cb1_m[0].y, cb1_m[0].z);
    float3 _1066 = o2;
    _1066.z = mad(_1054.z, r1.xyz.z, mad(_1054.y, r1.xyz.y, _1054.x * r1.xyz.x));
    o2 = _1066;
    float3 _1081 = o3;
    _1081.z = mad(r0.yzw.z, r1.xyz.z, mad(r0.yzw.y, r1.xyz.y, r0.yzw.x * r1.xyz.x));
    o3 = _1081;
    float3 _1096 = o3;
    _1096.x = mad(r0.yzw.z, r2.xyz.z, mad(r0.yzw.y, r2.xyz.y, r0.yzw.x * r2.xyz.x));
    o3 = _1096;
    float3 _1105 = float3(cb1_m[0].x, cb1_m[0].y, cb1_m[0].z);
    float3 _1117 = o2;
    _1117.x = mad(_1105.z, r2.xyz.z, mad(_1105.y, r2.xyz.y, _1105.x * r2.xyz.x));
    o2 = _1117;
    float2 _1123 = float2(asint(shader_in[2].xy));
    r0 = float4(_1123.x, _1123.y, r0.z, r0.w);
    float2 _1134 = r0.xy * float2(cb2_m[2].y, cb2_m[2].z);
    r0 = float4(_1134.x, _1134.y, r0.z, r0.w);
    float2 _1140 = r0.xy * asfloat(uint2(981467136u, 981467136u));
    o4 = float4(o4.x, o4.y, _1140.x, _1140.y);
    float2 _1147 = float2(asint(shader_in[1].xy));
    r0 = float4(_1147.x, _1147.y, r0.z, r0.w);
    float2 _1153 = r0.xy * asfloat(uint2(981467136u, 981467136u));
    o4 = float4(_1153.x, _1153.y, o4.z, o4.w);
}

void vert_main()
{
    shader_in[0] = float4(v0.x, v0.y, v0.z, shader_in[0].w);
    float2 _1162 = asfloat(v1);
    shader_in[1] = float4(_1162.x, _1162.y, shader_in[1].z, shader_in[1].w);
    float2 _1167 = asfloat(v2);
    shader_in[2] = float4(_1167.x, _1167.y, shader_in[2].z, shader_in[2].w);
    float2 _1172 = asfloat(v3);
    shader_in[3] = float4(_1172.x, _1172.y, shader_in[3].z, shader_in[3].w);
