...
void vs_main()
{
    ...
    float3 _1108 = o2;
    _1108.z = mad(_1096.z, r1.xyz.z, mad(_1096.y, r1.xyz.y, _1096.x * r1.xyz.x));
    o2 = _1108;
    float3 _1117 = float3(cb1_m[0].x, cb1_m[0].y, cb1_m[0].z);
    float3 _1129 = o2;
    _1129.x = mad(_1117.z, r2.xyz.z, mad(_1117.y, r2.xyz.y, _1117.x * r2.xyz.x));
    o2 = _1129;
    float4 _1144 = r0;
    _1144.x = mad(r0.yzw.z, r0.yzw.z, mad(r0.yzw.y, r0.yzw.y, r0.yzw.x * r0.yzw.x));
    r0 = _1144;
    float4 _1149 = r0;
    _1149.x = rsqrt(r0.x);
    r0 = _1149;
    float3 _1155 = r0.xxx * r0.yzw;
    r0 = float4(_1155.x, _1155.y, _1155.z, r0.w);
    float3 _1171 = o3;
    _1171.x = mad(r0.xyz.z, r2.xyz.z, mad(r0.xyz.y, r2.xyz.y, r0.xyz.x * r2.xyz.x));
    o3 = _1171;
    float3 _1186 = o3;
    _1186.z = mad(r0.xyz.z, r1.xyz.z, mad(r0.xyz.y, r1.xyz.y, r0.xyz.x * r1.xyz.x));
    o3 = _1186;
    float3 _1201 = o3;
    _1201.y = mad(r0.xyz.z, r3.xyz.z, mad(r0.xyz.y, r3.xyz.y, r0.xyz.x * r3.xyz.x));
    o3 = _1201;
    float2 _1207 = float2(asint(shader_in[2].xy));
    r0 = float4(_1207.x, _1207.y, r0.z, r0.w);
    float2 _1218 = r0.xy * float2(cb2_m[1].y, cb2_m[1].z);
    r0 = float4(_1218.x, _1218.y, r0.z, r0.w);
    float2 _1224 = r0.xy * asfloat(uint2(981467136u, 981467136u));
    o4 = float4(o4.x, o4.y, _1224.x, _1224.y);
    float2 _1231 = float2(asint(shader_in[1].xy));
    r0 = float4(_1231.x, _1231.y, r0.z, r0.w);
    float2 _1237 = r0.xy * asfloat(uint2(981467136u, 981467136u));
    o4 = float4(_1237.x, _1237.y, o4.z, o4.w);
}
...
void vert_main()
{
    ...
    float2 _1251 = asfloat(v2);
    shader_in[2] = float4(_1251.x, _1251.y, shader_in[2].z, shader_in[2].w);
    float2 _1256 = asfloat(v3);
    shader_in[3] = float4(_1256.x, _1256.y, shader_in[3].z, shader_in[3].w);
