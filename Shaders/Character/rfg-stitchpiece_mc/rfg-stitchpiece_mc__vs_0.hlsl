...
void vs_main()
{
    ...
    float3 _1072 = float3(cb1_m[0].x, cb1_m[0].y, cb1_m[0].z);
    float3 _1084 = o2;
    _1084.y = mad(_1072.z, r2.xyz.z, mad(_1072.y, r2.xyz.y, _1072.x * r2.xyz.x));
    o2 = _1084;
    float3 _1093 = float3(cb1_m[0].x, cb1_m[0].y, cb1_m[0].z);
    float3 _1105 = o2;
    _1105.z = mad(_1093.z, r0.yzw.z, mad(_1093.y, r0.yzw.y, _1093.x * r0.yzw.x));
    o2 = _1105;
    float3 _1114 = float3(cb1_m[0].x, cb1_m[0].y, cb1_m[0].z);
    float3 _1126 = o2;
    _1126.x = mad(_1114.z, r1.xyz.z, mad(_1114.y, r1.xyz.y, _1114.x * r1.xyz.x));
    o2 = _1126;
    float3 _1140 = (-r4.xyz) + float3(cb0_m[11].x, cb0_m[11].y, cb0_m[11].z);
    r3 = float4(_1140.x, _1140.y, _1140.z, r3.w);
    float3 _1154 = r4.xyz + (-float3(cb0_m[11].x, cb0_m[11].y, cb0_m[11].z));
    r4 = float4(_1154.x, _1154.y, _1154.z, r4.w);
    float4 _1170 = r0;
    _1170.x = mad(r3.xyz.z, r3.xyz.z, mad(r3.xyz.y, r3.xyz.y, r3.xyz.x * r3.xyz.x));
    r0 = _1170;
    float4 _1175 = r0;
    _1175.x = rsqrt(r0.x);
    r0 = _1175;
    float3 _1181 = r0.xxx * r3.xyz;
    r3 = float4(_1181.x, _1181.y, _1181.z, r3.w);
    float3 _1197 = o3;
    ...
    o4 = _1201;
    float3 _1216 = o3;
    _1216.x = mad(r3.xyz.z, r1.xyz.z, mad(r3.xyz.y, r1.xyz.y, r3.xyz.x * r1.xyz.x));
    o3 = _1216;
    float4 _1220 = o4;
    _1220.x = r1.y;
    o4 = _1220;
    float3 _1235 = o3;
    _1235.y = mad(r3.xyz.z, r2.xyz.z, mad(r3.xyz.y, r2.xyz.y, r3.xyz.x * r2.xyz.x));
    o3 = _1235;
    float4 _1239 = o4;
    _1239.y = r2.y;
    o4 = _1239;
    ...
    o4 = _1355;
    float2 _1361 = float2(asint(shader_in[1].xy));
    r0 = float4(_1361.x, _1361.y, r0.z, r0.w);
    float2 _1367 = r0.xy * asfloat(uint2(981467136u, 981467136u));
    o5 = float4(_1367.x, _1367.y, o5.z, o5.w);
    float2 _1374 = float2(asint(shader_in[3].xy));
    r0 = float4(_1374.x, _1374.y, r0.z, r0.w);
    float2 _1380 = r0.xy * asfloat(uint2(981467136u, 981467136u));
