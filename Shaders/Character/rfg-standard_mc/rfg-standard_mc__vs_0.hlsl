...
void vs_main()
{
    ...
    float3 _1170 = o3;
    _1170.z = mad(r3.xyz.z, r0.yzw.z, mad(r3.xyz.y, r0.yzw.y, r3.xyz.x * r0.yzw.x));
    o3 = _1170;
    float4 _1174 = o4;
    _1174.z = r0.z;
    o4 = _1174;
    float3 _1189 = o3;
    _1189.x = mad(r3.xyz.z, r1.xyz.z, mad(r3.xyz.y, r1.xyz.y, r3.xyz.x * r1.xyz.x));
    o3 = _1189;
    float4 _1193 = o4;
    _1193.x = r1.y;
    o4 = _1193;
    ...
    o4 = _1212;
    float4 _1221 = r0;
    _1221.x = r4.y * cb0_m[13].x;
    r0 = _1221;
    float4 _1228 = r0;
    _1228.y = r0.x * asfloat(3216550459u);
    r0 = _1228;
    float4 _1233 = r0;
    _1233.y = exp2(r0.y);
    r0 = _1233;
    float4 _1240 = r0;
    _1240.y = (-r0.y) + asfloat(1065353216u);
    r0 = _1240;
    float4 _1247 = r0;
    _1247.x = r0.y / r0.x;
    r0 = _1247;
    float4 _1259 = r0;
    _1259.y = asfloat((asfloat(1008981770u) < abs(r4.y)) ? 4294967295u : 0u);
    r0 = _1259;
    float4 _1274 = r0;
    _1274.z = mad(r4.xyz.z, r4.xyz.z, mad(r4.xyz.y, r4.xyz.y, r4.xyz.x * r4.xyz.x));
    r0 = _1274;
    float4 _1279 = r0;
    _1279.z = sqrt(r0.z);
    r0 = _1279;
    float4 _1287 = r0;
    _1287.z = r0.z * cb0_m[13].y;
    r0 = _1287;
    float4 _1297 = r0;
    _1297.x = (asuint(r0.y) != 0u) ? r0.x : asfloat(1065353216u);
    r0 = _1297;
    float4 _1309 = r0;
    _1309.x = (r0.x * r0.z) + (-cb0_m[13].w);
    r0 = _1309;
    float4 _1315 = r0;
    _1315.x = exp2(-r0.x);
    r0 = _1315;
    float4 _1321 = r0;
    _1321.x = min(r0.x, asfloat(1065353216u));
    r0 = _1321;
    float4 _1328 = o4;
    _1328.w = (-r0.x) + asfloat(1065353216u);
    o4 = _1328;
    ...
    o5 = float4(_1340.x, _1340.y, o5.z, o5.w);
    float2 _1347 = float2(asint(shader_in[3].xy));
    r0 = float4(_1347.x, _1347.y, r0.z, r0.w);
    float2 _1353 = r0.xy * asfloat(uint2(981467136u, 981467136u));
    o5 = float4(o5.x, o5.y, _1353.x, _1353.y);
}

void vert_main()
{
    shader_in[0] = float4(v0.x, v0.y, v0.z, shader_in[0].w);
    float2 _1362 = asfloat(v1);
    shader_in[1] = float4(_1362.x, _1362.y, shader_in[1].z, shader_in[1].w);
    float2 _1367 = asfloat(v2);
    shader_in[2] = float4(_1367.x, _1367.y, shader_in[2].z, shader_in[2].w);
    float2 _1372 = asfloat(v3);
    shader_in[3] = float4(_1372.x, _1372.y, shader_in[3].z, shader_in[3].w);
