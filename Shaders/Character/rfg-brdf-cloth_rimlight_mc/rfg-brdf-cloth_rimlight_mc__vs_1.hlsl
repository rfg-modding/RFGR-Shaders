...
void vs_main()
{
    ...
    float2 _622 = r0.yz * float2(cb2_m[5].x, cb2_m[5].y);
    r0 = float4(r0.x, _622.x, _622.y, r0.w);
    o1 = r0.yz * asfloat(uint2(981467136u, 981467136u));
    float3 _642 = (shader_in[2].xyz * asfloat(uint3(1073741824u, 1073741824u, 1073741824u))) + asfloat(uint3(3212836864u, 3212836864u, 3212836864u));
    ...
    float3 _1072 = (-r4.xyz) + float3(cb1_m[0].x, cb1_m[0].y, cb1_m[0].z);
    r3 = float4(_1072.x, _1072.y, _1072.z, r3.w);
    float3 _1088 = o2;
    _1088.y = mad(r3.xyz.z, r2.xyz.z, mad(r3.xyz.y, r2.xyz.y, r3.xyz.x * r2.xyz.x));
    o2 = _1088;
    float3 _1103 = o2;
    _1103.z = mad(r3.xyz.z, r0.yzw.z, mad(r3.xyz.y, r0.yzw.y, r3.xyz.x * r0.yzw.x));
    o2 = _1103;
    float3 _1118 = o2;
    _1118.x = mad(r3.xyz.z, r1.xyz.z, mad(r3.xyz.y, r1.xyz.y, r3.xyz.x * r1.xyz.x));
    o2 = _1118;
    float3 _1132 = (-r4.xyz) + float3(cb0_m[11].x, cb0_m[11].y, cb0_m[11].z);
    r3 = float4(_1132.x, _1132.y, _1132.z, r3.w);
    float3 _1146 = r4.xyz + (-float3(cb0_m[11].x, cb0_m[11].y, cb0_m[11].z));
    r4 = float4(_1146.x, _1146.y, _1146.z, r4.w);
    float4 _1162 = r0;
    _1162.x = mad(r3.xyz.z, r3.xyz.z, mad(r3.xyz.y, r3.xyz.y, r3.xyz.x * r3.xyz.x));
    r0 = _1162;
    float4 _1167 = r0;
    _1167.x = rsqrt(r0.x);
    r0 = _1167;
    float3 _1173 = r0.xxx * r3.xyz;
    r3 = float4(_1173.x, _1173.y, _1173.z, r3.w);
    float3 _1189 = o3;
    _1189.z = mad(r3.xyz.z, r0.yzw.z, mad(r3.xyz.y, r0.yzw.y, r3.xyz.x * r0.yzw.x));
    o3 = _1189;
    float3 _1198 = float3(cb1_m[1].x, cb1_m[1].y, cb1_m[1].z);
    float4 _1210 = o4;
    _1210.z = mad(_1198.z, r0.yzw.z, mad(_1198.y, r0.yzw.y, _1198.x * r0.yzw.x));
    o4 = _1210;
    float3 _1225 = o3;
    _1225.x = mad(r3.xyz.z, r1.xyz.z, mad(r3.xyz.y, r1.xyz.y, r3.xyz.x * r1.xyz.x));
    o3 = _1225;
    float3 _1234 = float3(cb1_m[1].x, cb1_m[1].y, cb1_m[1].z);
    float4 _1246 = o4;
    _1246.x = mad(_1234.z, r1.xyz.z, mad(_1234.y, r1.xyz.y, _1234.x * r1.xyz.x));
    o4 = _1246;
    float3 _1261 = o3;
    _1261.y = mad(r3.xyz.z, r2.xyz.z, mad(r3.xyz.y, r2.xyz.y, r3.xyz.x * r2.xyz.x));
    o3 = _1261;
    float3 _1270 = float3(cb1_m[1].x, cb1_m[1].y, cb1_m[1].z);
    float4 _1282 = o4;
    _1282.y = mad(_1270.z, r2.xyz.z, mad(_1270.y, r2.xyz.y, _1270.x * r2.xyz.x));
    o4 = _1282;
    float4 _1291 = r0;
    _1291.x = r4.y * cb0_m[13].x;
    r0 = _1291;
    float4 _1298 = r0;
    _1298.y = r0.x * asfloat(3216550459u);
    r0 = _1298;
    float4 _1303 = r0;
    _1303.y = exp2(r0.y);
    r0 = _1303;
    float4 _1310 = r0;
    _1310.y = (-r0.y) + asfloat(1065353216u);
    r0 = _1310;
    float4 _1317 = r0;
    _1317.x = r0.y / r0.x;
    r0 = _1317;
    float4 _1329 = r0;
    _1329.y = asfloat((asfloat(1008981770u) < abs(r4.y)) ? 4294967295u : 0u);
    r0 = _1329;
    float4 _1344 = r0;
    _1344.z = mad(r4.xyz.z, r4.xyz.z, mad(r4.xyz.y, r4.xyz.y, r4.xyz.x * r4.xyz.x));
    r0 = _1344;
    float4 _1349 = r0;
    _1349.z = sqrt(r0.z);
    r0 = _1349;
    float4 _1357 = r0;
    _1357.z = r0.z * cb0_m[13].y;
    r0 = _1357;
    float4 _1367 = r0;
    _1367.x = (asuint(r0.y) != 0u) ? r0.x : asfloat(1065353216u);
    r0 = _1367;
    float4 _1379 = r0;
    _1379.x = (r0.x * r0.z) + (-cb0_m[13].w);
    r0 = _1379;
    float4 _1385 = r0;
    _1385.x = exp2(-r0.x);
    r0 = _1385;
    float4 _1391 = r0;
    _1391.x = min(r0.x, asfloat(1065353216u));
    r0 = _1391;
    float4 _1398 = o4;
    _1398.w = (-r0.x) + asfloat(1065353216u);
    o4 = _1398;
}
...
void vert_main()
{
    ...
    float2 _1406 = asfloat(v1);
    shader_in[1] = float4(_1406.x, _1406.y, shader_in[1].z, shader_in[1].w);
