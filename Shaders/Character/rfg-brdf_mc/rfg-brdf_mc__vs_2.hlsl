...
void vs_main()
{
    ...
    float2 _635 = r1.xy * float2(cb2_m[7].x, cb2_m[7].y);
    r1 = float4(_635.x, _635.y, r1.z, r1.w);
    o1 = r1.xy * asfloat(uint2(981467136u, 981467136u));
    float3 _655 = (shader_in[2].xyz * asfloat(uint3(1073741824u, 1073741824u, 1073741824u))) + asfloat(uint3(3212836864u, 3212836864u, 3212836864u));
