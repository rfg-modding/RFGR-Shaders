...
void vs_main()
{
    ...
    o2 = _1126;
    float2 _1133 = float2(asint(shader_in[1].xy));
    r0 = float4(_1133.x, _1133.y, r0.z, r0.w);
    float2 _1145 = r0.xy * float2(cb2_m[7].x, cb2_m[7].y);
    r0 = float4(_1145.x, _1145.y, r0.z, r0.w);
    float2 _1154 = r0.xy * asfloat(uint2(981467136u, 981467136u));
    o3 = float4(_1154.x, _1154.y, o3.z, o3.w);
    float2 _1161 = float2(asint(shader_in[2].xy));
    r0 = float4(_1161.x, _1161.y, r0.z, r0.w);
    float2 _1167 = r0.xy * asfloat(uint2(981467136u, 981467136u));
    o3 = float4(o3.x, o3.y, _1167.x, _1167.y);
}

void vert_main()
{
    shader_in[0] = float4(v0.x, v0.y, v0.z, shader_in[0].w);
    float2 _1176 = asfloat(v1);
    shader_in[1] = float4(_1176.x, _1176.y, shader_in[1].z, shader_in[1].w);
    float2 _1181 = asfloat(v2);
    shader_in[2] = float4(_1181.x, _1181.y, shader_in[2].z, shader_in[2].w);
