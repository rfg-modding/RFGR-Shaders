...
void vs_main()
{
    ...
    o0 = _579;
    float4 _588 = r0;
    _588.x = cb6_m[3].x * cb2_m[1].x;
    r0 = _588;
    float4 _595 = r0;
    _595.x = r0.x * asfloat(1092616192u);
    r0 = _595;
    float2 _601 = float2(asint(shader_in[1].xy));
    r0 = float4(r0.x, r0.y, _601.x, _601.y);
    float4 _605 = r0;
    _605.y = asfloat(0u);
    r0 = _605;
...
void vert_main()
{
    ...
    float2 _633 = asfloat(v1);
    shader_in[1] = float4(_633.x, _633.y, shader_in[1].z, shader_in[1].w);
    shader_in[3] = v3;
