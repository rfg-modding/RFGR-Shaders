...
void vs_main()
{
    ...
    o0 = _590;
    float4 _599 = r0;
    _599.x = cb6_m[3].x * cb2_m[1].x;
    r0 = _599;
    float4 _606 = r0;
    _606.x = r0.x * asfloat(1092616192u);
    r0 = _606;
    float2 _612 = float2(asint(shader_in[1].xy));
    r0 = float4(r0.x, r0.y, _612.x, _612.y);
    float4 _616 = r0;
    _616.y = asfloat(0u);
    r0 = _616;
...
void vert_main()
{
    ...
    float2 _644 = asfloat(v1);
    shader_in[1] = float4(_644.x, _644.y, shader_in[1].z, shader_in[1].w);
    shader_in[3] = v3;
    shader_in[5] = v5;
