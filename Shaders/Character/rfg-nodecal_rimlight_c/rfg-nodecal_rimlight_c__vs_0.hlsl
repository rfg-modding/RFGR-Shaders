...
void vs_main()
{
    ...
    float4 _1093 = r0;
    _1093.x = mad(r3.xyz.z, r3.xyz.z, mad(r3.xyz.y, r3.xyz.y, r3.xyz.x * r3.xyz.x));
    r0 = _1093;
    float4 _1098 = r0;
    _1098.x = rsqrt(r0.x);
    r0 = _1098;
    float3 _1104 = r0.xxx * r3.xyz;
    r3 = float4(_1104.x, _1104.y, _1104.z, r3.w);
    float3 _1120 = o3;
    _1120.x = mad(r3.xyz.z, r1.xyz.z, mad(r3.xyz.y, r1.xyz.y, r3.xyz.x * r1.xyz.x));
    o3 = _1120;
    float4 _1124 = o4;
    _1124.x = r1.y;
    o4 = _1124;
    float3 _1139 = o3;
    _1139.z = mad(r3.xyz.z, r0.yzw.z, mad(r3.xyz.y, r0.yzw.y, r3.xyz.x * r0.yzw.x));
    o3 = _1139;
    float4 _1143 = o4;
    _1143.z = r0.z;
    o4 = _1143;
    float3 _1158 = o3;
    _1158.y = mad(r3.xyz.z, r2.xyz.z, mad(r3.xyz.y, r2.xyz.y, r3.xyz.x * r2.xyz.x));
    o3 = _1158;
    float4 _1162 = o4;
    _1162.y = r2.y;
    o4 = _1162;
    float4 _1171 = r0;
    _1171.x = r4.y * cb0_m[13].x;
    r0 = _1171;
    float4 _1178 = r0;
    _1178.y = r0.x * asfloat(3216550459u);
    r0 = _1178;
    float4 _1183 = r0;
    _1183.y = exp2(r0.y);
    r0 = _1183;
    float4 _1190 = r0;
    _1190.y = (-r0.y) + asfloat(1065353216u);
    r0 = _1190;
    float4 _1197 = r0;
    _1197.x = r0.y / r0.x;
    r0 = _1197;
    float4 _1209 = r0;
    _1209.y = asfloat((asfloat(1008981770u) < abs(r4.y)) ? 4294967295u : 0u);
    r0 = _1209;
    float4 _1224 = r0;
    _1224.z = mad(r4.xyz.z, r4.xyz.z, mad(r4.xyz.y, r4.xyz.y, r4.xyz.x * r4.xyz.x));
    r0 = _1224;
    float4 _1229 = r0;
    _1229.z = sqrt(r0.z);
    r0 = _1229;
    float4 _1237 = r0;
    _1237.z = r0.z * cb0_m[13].y;
    r0 = _1237;
    float4 _1247 = r0;
    _1247.x = (asuint(r0.y) != 0u) ? r0.x : asfloat(1065353216u);
    r0 = _1247;
    float4 _1259 = r0;
    _1259.x = (r0.x * r0.z) + (-cb0_m[13].w);
    r0 = _1259;
    float4 _1265 = r0;
    _1265.x = exp2(-r0.x);
    r0 = _1265;
    float4 _1271 = r0;
    _1271.x = min(r0.x, asfloat(1065353216u));
    r0 = _1271;
    float4 _1278 = o4;
    _1278.w = (-r0.x) + asfloat(1065353216u);
    o4 = _1278;
}
...
void vert_main()
{
    ...
    float2 _1286 = asfloat(v1);
    shader_in[1] = float4(_1286.x, _1286.y, shader_in[1].z, shader_in[1].w);
