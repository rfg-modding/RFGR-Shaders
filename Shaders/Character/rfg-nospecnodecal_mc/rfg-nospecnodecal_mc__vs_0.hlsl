...
void vs_main()
{
    ...
    _1082.y = r3.y;
    o3 = _1082;
    float3 _1091 = float3(cb1_m[0].x, cb1_m[0].y, cb1_m[0].z);
    float3 _1103 = o2;
    _1103.z = mad(_1091.z, r1.xyz.z, mad(_1091.y, r1.xyz.y, _1091.x * r1.xyz.x));
    o2 = _1103;
    float4 _1107 = o3;
    _1107.z = r1.y;
    o3 = _1107;
    float3 _1116 = float3(cb1_m[0].x, cb1_m[0].y, cb1_m[0].z);
    float3 _1128 = o2;
    _1128.x = mad(_1116.z, r2.xyz.z, mad(_1116.y, r2.xyz.y, _1116.x * r2.xyz.x));
    o2 = _1128;
    float4 _1132 = o3;
    _1132.x = r2.y;
    o3 = _1132;
    float4 _1141 = r0;
    _1141.x = r0.z * cb0_m[13].x;
    r0 = _1141;
    float4 _1148 = r1;
    _1148.x = r0.x * asfloat(3216550459u);
    r1 = _1148;
    float4 _1153 = r1;
    _1153.x = exp2(r1.x);
    r1 = _1153;
    float4 _1160 = r1;
    _1160.x = (-r1.x) + asfloat(1065353216u);
    r1 = _1160;
    float4 _1167 = r0;
    _1167.x = r1.x / r0.x;
    r0 = _1167;
    float4 _1179 = r1;
    _1179.x = asfloat((asfloat(1008981770u) < abs(r0.z)) ? 4294967295u : 0u);
    r1 = _1179;
    float4 _1194 = r0;
    _1194.y = mad(r0.yzw.z, r0.yzw.z, mad(r0.yzw.y, r0.yzw.y, r0.yzw.x * r0.yzw.x));
    r0 = _1194;
    float4 _1199 = r0;
    _1199.y = sqrt(r0.y);
    r0 = _1199;
    float4 _1207 = r0;
    _1207.y = r0.y * cb0_m[13].y;
    r0 = _1207;
    float4 _1217 = r0;
    _1217.x = (asuint(r1.x) != 0u) ? r0.x : asfloat(1065353216u);
    r0 = _1217;
    float4 _1229 = r0;
    _1229.x = (r0.x * r0.y) + (-cb0_m[13].w);
    r0 = _1229;
    float4 _1235 = r0;
    _1235.x = exp2(-r0.x);
    r0 = _1235;
    float4 _1241 = r0;
    _1241.x = min(r0.x, asfloat(1065353216u));
    r0 = _1241;
    float4 _1248 = o3;
    _1248.w = (-r0.x) + asfloat(1065353216u);
    o3 = _1248;
}
...
void vert_main()
{
    ...
    float2 _1256 = asfloat(v1);
    shader_in[1] = float4(_1256.x, _1256.y, shader_in[1].z, shader_in[1].w);
