...
void vs_main()
{
    ...
    o2 = _1078;
    float3 _1093 = o3;
    _1093.y = mad(r0.yzw.z, r3.xyz.z, mad(r0.yzw.y, r3.xyz.y, r0.yzw.x * r3.xyz.x));
    o3 = _1093;
    ...
    o2 = _1114;
    float3 _1129 = o3;
    _1129.z = mad(r0.yzw.z, r1.xyz.z, mad(r0.yzw.y, r1.xyz.y, r0.yzw.x * r1.xyz.x));
    o3 = _1129;
    float3 _1144 = o3;
    _1144.x = mad(r0.yzw.z, r2.xyz.z, mad(r0.yzw.y, r2.xyz.y, r0.yzw.x * r2.xyz.x));
    o3 = _1144;
    float3 _1153 = float3(cb1_m[0].x, cb1_m[0].y, cb1_m[0].z);
    float3 _1165 = o2;
    _1165.x = mad(_1153.z, r2.xyz.z, mad(_1153.y, r2.xyz.y, _1153.x * r2.xyz.x));
    o2 = _1165;
}
...
void vert_main()
{
    ...
    float2 _1173 = asfloat(v1);
    shader_in[1] = float4(_1173.x, _1173.y, shader_in[1].z, shader_in[1].w);
