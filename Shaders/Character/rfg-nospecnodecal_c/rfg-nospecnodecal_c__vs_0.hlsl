...
void vs_main()
{
    ...
    _1025.y = r3.y;
    o3 = _1025;
    float3 _1034 = float3(cb1_m[0].x, cb1_m[0].y, cb1_m[0].z);
    float3 _1046 = o2;
    _1046.z = mad(_1034.z, r1.xyz.z, mad(_1034.y, r1.xyz.y, _1034.x * r1.xyz.x));
    o2 = _1046;
    float4 _1050 = o3;
    _1050.z = r1.y;
    o3 = _1050;
    float3 _1059 = float3(cb1_m[0].x, cb1_m[0].y, cb1_m[0].z);
    float3 _1071 = o2;
    _1071.x = mad(_1059.z, r2.xyz.z, mad(_1059.y, r2.xyz.y, _1059.x * r2.xyz.x));
    o2 = _1071;
    float4 _1075 = o3;
    _1075.x = r2.y;
    o3 = _1075;
    float4 _1084 = r0;
    _1084.x = r0.z * cb0_m[13].x;
    r0 = _1084;
    float4 _1091 = r1;
    _1091.x = r0.x * asfloat(3216550459u);
    r1 = _1091;
    float4 _1096 = r1;
    _1096.x = exp2(r1.x);
    r1 = _1096;
    float4 _1103 = r1;
    _1103.x = (-r1.x) + asfloat(1065353216u);
    r1 = _1103;
    float4 _1110 = r0;
    _1110.x = r1.x / r0.x;
    r0 = _1110;
    float4 _1122 = r1;
    _1122.x = asfloat((asfloat(1008981770u) < abs(r0.z)) ? 4294967295u : 0u);
    r1 = _1122;
    float4 _1137 = r0;
    _1137.y = mad(r0.yzw.z, r0.yzw.z, mad(r0.yzw.y, r0.yzw.y, r0.yzw.x * r0.yzw.x));
    r0 = _1137;
    float4 _1142 = r0;
    _1142.y = sqrt(r0.y);
    r0 = _1142;
    float4 _1150 = r0;
    _1150.y = r0.y * cb0_m[13].y;
    r0 = _1150;
    float4 _1160 = r0;
    _1160.x = (asuint(r1.x) != 0u) ? r0.x : asfloat(1065353216u);
    r0 = _1160;
    float4 _1172 = r0;
    _1172.x = (r0.x * r0.y) + (-cb0_m[13].w);
    r0 = _1172;
    float4 _1178 = r0;
    _1178.x = exp2(-r0.x);
    r0 = _1178;
    float4 _1184 = r0;
    _1184.x = min(r0.x, asfloat(1065353216u));
    r0 = _1184;
    float4 _1191 = o3;
    _1191.w = (-r0.x) + asfloat(1065353216u);
    o3 = _1191;
}
...
void vert_main()
{
    ...
    float2 _1199 = asfloat(v1);
    shader_in[1] = float4(_1199.x, _1199.y, shader_in[1].z, shader_in[1].w);
