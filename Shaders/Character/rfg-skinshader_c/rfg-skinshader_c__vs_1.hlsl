...
void vs_main()
{
    ...
    float3 _1089 = o3;
    _1089.x = mad(r3.xyz.z, r1.xyz.z, mad(r3.xyz.y, r1.xyz.y, r3.xyz.x * r1.xyz.x));
    o3 = _1089;
    float3 _1098 = float3(cb1_m[1].x, cb1_m[1].y, cb1_m[1].z);
    float4 _1110 = o4;
    _1110.x = mad(_1098.z, r1.xyz.z, mad(_1098.y, r1.xyz.y, _1098.x * r1.xyz.x));
    o4 = _1110;
    float3 _1125 = o3;
    _1125.z = mad(r3.xyz.z, r0.yzw.z, mad(r3.xyz.y, r0.yzw.y, r3.xyz.x * r0.yzw.x));
    o3 = _1125;
    ...
    o4 = _1146;
    float3 _1161 = o3;
    _1161.y = mad(r3.xyz.z, r2.xyz.z, mad(r3.xyz.y, r2.xyz.y, r3.xyz.x * r2.xyz.x));
    o3 = _1161;
    float3 _1170 = float3(cb1_m[1].x, cb1_m[1].y, cb1_m[1].z);
    float4 _1182 = o4;
    _1182.y = mad(_1170.z, r2.xyz.z, mad(_1170.y, r2.xyz.y, _1170.x * r2.xyz.x));
    o4 = _1182;
    float4 _1191 = r0;
...
void vert_main()
{
    ...
    float2 _1306 = asfloat(v1);
    shader_in[1] = float4(_1306.x, _1306.y, shader_in[1].z, shader_in[1].w);
