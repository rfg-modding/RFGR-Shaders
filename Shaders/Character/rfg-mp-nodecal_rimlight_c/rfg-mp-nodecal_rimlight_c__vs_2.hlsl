...
void vs_main()
{
    ...
    o2 = _1021;
    float3 _1030 = float3(cb1_m[0].x, cb1_m[0].y, cb1_m[0].z);
    float3 _1042 = o2;
    _1042.z = mad(_1030.z, r1.xyz.z, mad(_1030.y, r1.xyz.y, _1030.x * r1.xyz.x));
    o2 = _1042;
    float3 _1051 = float3(cb1_m[0].x, cb1_m[0].y, cb1_m[0].z);
    float3 _1063 = o2;
    _1063.x = mad(_1051.z, r2.xyz.z, mad(_1051.y, r2.xyz.y, _1051.x * r2.xyz.x));
    o2 = _1063;
    float4 _1078 = r0;
    _1078.x = mad(r0.yzw.z, r0.yzw.z, mad(r0.yzw.y, r0.yzw.y, r0.yzw.x * r0.yzw.x));
    r0 = _1078;
    float4 _1083 = r0;
    _1083.x = rsqrt(r0.x);
    r0 = _1083;
    float3 _1089 = r0.xxx * r0.yzw;
    r0 = float4(_1089.x, _1089.y, _1089.z, r0.w);
    float3 _1105 = o3;
    _1105.x = mad(r0.xyz.z, r2.xyz.z, mad(r0.xyz.y, r2.xyz.y, r0.xyz.x * r2.xyz.x));
    o3 = _1105;
    float3 _1120 = o3;
    _1120.z = mad(r0.xyz.z, r1.xyz.z, mad(r0.xyz.y, r1.xyz.y, r0.xyz.x * r1.xyz.x));
    o3 = _1120;
    float3 _1135 = o3;
    _1135.y = mad(r0.xyz.z, r3.xyz.z, mad(r0.xyz.y, r3.xyz.y, r0.xyz.x * r3.xyz.x));
    o3 = _1135;
}
