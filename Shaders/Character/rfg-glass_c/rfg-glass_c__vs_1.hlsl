...
void vs_main()
{
    ...
    o4 = r0.xxx * r2.xyz;
    float4 _856 = r0;
    _856.x = r1.y * cb0_m[13].x;
    r0 = _856;
    float4 _863 = r0;
    _863.y = r0.x * asfloat(3216550459u);
    r0 = _863;
    float4 _868 = r0;
    _868.y = exp2(r0.y);
    r0 = _868;
    float4 _875 = r0;
    _875.y = (-r0.y) + asfloat(1065353216u);
    r0 = _875;
    float4 _882 = r0;
    _882.x = r0.y / r0.x;
    r0 = _882;
    float4 _894 = r0;
    _894.y = asfloat((asfloat(1008981770u) < abs(r1.y)) ? 4294967295u : 0u);
    r0 = _894;
    float4 _909 = r0;
    _909.z = mad(r1.xyz.z, r1.xyz.z, mad(r1.xyz.y, r1.xyz.y, r1.xyz.x * r1.xyz.x));
    r0 = _909;
    float4 _914 = r0;
    _914.z = sqrt(r0.z);
    r0 = _914;
    float4 _922 = r0;
    _922.z = r0.z * cb0_m[13].y;
    r0 = _922;
    float4 _932 = r0;
    _932.x = (asuint(r0.y) != 0u) ? r0.x : asfloat(1065353216u);
    r0 = _932;
    float4 _944 = r0;
    _944.x = (r0.x * r0.z) + (-cb0_m[13].w);
    r0 = _944;
    float4 _950 = r0;
    _950.x = exp2(-r0.x);
    r0 = _950;
    float4 _956 = r0;
    _956.x = min(r0.x, asfloat(1065353216u));
    r0 = _956;
    float4 _963 = o5;
    _963.w = (-r0.x) + asfloat(1065353216u);
    o5 = _963;
    float3 _972 = float3(cb1_m[1].x, cb1_m[1].y, cb1_m[1].z);
    o5 = float4(_972.x, _972.y, _972.z, o5.w);
}

void vert_main()
{
    shader_in[0] = float4(v0.x, v0.y, v0.z, shader_in[0].w);
    float2 _981 = asfloat(v1);
    shader_in[1] = float4(_981.x, _981.y, shader_in[1].z, shader_in[1].w);
