...
void vs_main()
{
    ...
    r1 = _422;
    float4 _433 = float4(cb6_m[2].x, cb6_m[2].y, cb6_m[2].z, cb6_m[2].w);
    float4 _447 = r1;
    _447.z = mad(_433.w, r0.w, mad(_433.z, r0.z, mad(_433.y, r0.y, _433.x * r0.x)));
    r1 = _447;
    float4 _458 = float4(cb6_m[1].x, cb6_m[1].y, cb6_m[1].z, cb6_m[1].w);
    float4 _472 = r1;
    _472.y = mad(_458.w, r0.w, mad(_458.z, r0.z, mad(_458.y, r0.y, _458.x * r0.x)));
    r1 = _472;
    float4 _475 = r1;
    ...
    float4 _606 = r0;
    _606.w = asfloat((cb6_m[3].w < r1.y) ? 4294967295u : 0u);
    r0 = _606;
    float4 _613 = o1;
    _613.w = asfloat(asuint(r0.w) & 1065353216u);
    o1 = _613;
    float4 _622 = r0;
    ...
    r0 = _720;
    float3 _727 = o2;
    _727.z = (-r0.x) + asfloat(1065353216u);
    o2 = _727;
    float2 _734 = float2(asint(shader_in[1].xy));
    r0 = float4(_734.x, _734.y, r0.z, r0.w);
    float2 _743 = r0.xy * asfloat(uint2(989855744u, 989855744u));
    o2 = float3(_743.x, _743.y, o2.z);
}
