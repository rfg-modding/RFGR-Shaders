...
void vs_main()
{
    ...
    float4 _591 = r0;
    _591.x = asfloat((cb6_m[3].w < r1.y) ? 4294967295u : 0u);
    r0 = _591;
    float4 _598 = o2;
    _598.w = asfloat(asuint(r0.x) & 1065353216u);
    o2 = _598;
    float2 _604 = float2(asint(shader_in[1].xy));
    r0 = float4(_604.x, _604.y, r0.z, r0.w);
...
void vert_main()
{
    ...
    float2 _620 = asfloat(v1);
    shader_in[1] = float4(_620.x, _620.y, shader_in[1].z, shader_in[1].w);
    shader_in[3] = v3;
