...
void vs_main()
{
    ...
    r0 = _854;
    float2 _865 = asfloat(uint2(1065353216u, 1065353216u)) / float2(cb3_m[8].x, cb3_m[8].y);
    r0 = float4(r0.x, r0.y, _865.x, _865.y);
    float2 _873 = r0.zw * shader_in[3].xy;
    r1 = float4(_873.x, _873.y, r1.z, r1.w);
    float4 _884 = o3;
    _884.x = (r0.y * r0.z) + r1.x;
    o3 = _884;
    float4 _894 = o3;
    _894.y = (r0.x * r0.w) + r1.y;
    o3 = _894;
    float4 _899 = o3;
    _899.z = shader_in[2].x;
    o3 = _899;
    float4 _905 = o3;
    _905.w = shader_in[4].x;
    o3 = _905;
}
...
void vert_main()
{
    shader_in[0] = v0;
    shader_in[1] = v1;
    float4 _914 = shader_in[2];
    _914.x = v2;
    shader_in[2] = _914;
    shader_in[3] = float4(v3.x, v3.y, shader_in[3].z, shader_in[3].w);
    float4 _922 = shader_in[4];
    _922.x = v4;
    shader_in[4] = _922;
    float4 _926 = shader_in[5];
    _926.x = v5;
    shader_in[5] = _926;
    shader_in[6] = v6;
    shader_in[7] = v7;
